...
install_kubernetes () {
    ...
    sudo LANG=C chroot $FILESYSTEM_ROOT apt-get update
    sudo LANG=C chroot $FILESYSTEM_ROOT apt-get -y install kubelet=${1}-00
    sudo LANG=C chroot $FILESYSTEM_ROOT apt-get -y install kubectl=${1}-00
    sudo LANG=C chroot $FILESYSTEM_ROOT apt-get -y install kubeadm=${1}-00
}
