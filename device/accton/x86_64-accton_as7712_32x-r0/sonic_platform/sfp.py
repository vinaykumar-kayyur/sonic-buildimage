...
CPLD_I2C_PATH = "/sys/bus/i2c/devices/4-0060/"
...
class Sfp(SfpBase):
    ...
    def tx_disable(self, tx_disable):
        ...
        if self.sfp_type == QSFP_TYPE:
            ...
            disable_path = "{}{}{}".format(CPLD_I2C_PATH, 'module_tx_disable_', self.port_num)
    ...
    def get_presence(self):
        ...
        val = self._api_helper.read_txt_file(
            CPLD_I2C_PATH + "module_present_" + str(self.port_num))
