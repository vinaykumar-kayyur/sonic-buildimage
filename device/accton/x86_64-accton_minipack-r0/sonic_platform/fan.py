...
class Fan(FanBase):
    ...
    def get_speed(self):
        ...
        speed = 0
        if self.is_psu_fan:
            psu_fan_path = "{}{}{}{}".format(self.hwmon_path, "psu", self.psu_index+1, '_fan_speed')
            ...
            if fan_speed_rpm is not None:
                ...
                return 0
        elif self.get_presence():    # 50%==3000        
            speed_path = "{}{}{}{}".format(self.hwmon_path, "fan", self.fan_tray_index+1, '_input')
            speed_input=self._api_helper.read_txt_file(speed_path)
            if speed_input is None:
                return 0
            else:
                speed=int(speed_input, 10)*100/6000
                if speed > 100:
                    speed=100
    ...
    def get_presence(self):
        ...
        if self.is_psu_fan:
            present_path="{}{}{}{}".format(self.hwmon_path, 'psu', self.psu_index+1, '_fan_speed') 
        else:
            present_path = "{}{}{}{}".format(self.hwmon_path, "fan", self.fan_tray_index+1, '_input')        
        val=self._api_helper.read_txt_file(present_path)
        if val is not None and int(val, 10)!=0:
            return True
        else:
            return False
    ...
    def get_status(self):
        ...
        if self.is_psu_fan:            
            ...
            path="{}{}{}{}".format(self.hwmon_path, "fan", self.fan_tray_index+1, '_input')
