...
#from port0_eeprom to port127_eeprom
I2C_EEPROM_PATH = "/usr/local/bin/minipack_qsfp/port{0}_eeprom"
...
class Sfp(SfpBase):
    ...
    def _get_eeprom_path(self):
        #print("Check _get_eeprom_path")
        port_eeprom_path = I2C_EEPROM_PATH.format(self.port_num-1)
    ...
    def get_lpmode(self):
        ...
        """
        pim = FpgaUtil()
        return pim.get_low_power_mode(self.port_num-1)==1
    ...
    def set_lpmode(self, lpmode):
        ...
        """
        pim = FpgaUtil()
        pim.set_low_power_mode(self.port_num-1, lpmode)
        return True
