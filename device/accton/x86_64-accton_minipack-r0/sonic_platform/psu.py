...
PSU_NAME_LIST = ["PSU-1", "PSU-2", "PSU-3", "PSU-4"]
PSU_NUM_FAN = [1, 1, 1, 1]
...
class Psu(PsuBase):
    ...
    def get_voltage(self):
        ...
        Returns:
            ...
            e.g. 12.1
        """
        vout_path = "{}{}{}{}".format(self.hwmon_path, 'in', (self.index+1)*2, '_input' )
    ...
    def get_current(self):
        ...
        """
        iout_path = "{}{}{}{}".format(self.hwmon_path, 'curr', (self.index+1)*2, '_input' )
    ...
    def get_power(self):
        ...
        """
        pout_path = "{}{}{}{}".format(self.hwmon_path, 'power', (self.index+1)*2, '_input' )
    ...
    def get_temperature(self):
        ...
        """
        temp_path = "{}{}{}{}".format(self.hwmon_path, 'psu', self.index+1, '_temp_input')
    ...
    def get_status(self):
        ...
        """
        power_path="{}{}{}{}".format(self.hwmon_path, 'power', (self.index+1)*2, '_input' )
    ...
    def get_model(self):
        ...
        """
        model_path="{}{}{}{}".format(self.hwmon_path, 'psu' , (self.index+1) ,'_model_name')
    ...
    def get_serial(self):
        ...
        """
        serial_path="{}{}{}{}".format(self.hwmon_path, 'psu' , self.index+1 ,'_serial_num')
