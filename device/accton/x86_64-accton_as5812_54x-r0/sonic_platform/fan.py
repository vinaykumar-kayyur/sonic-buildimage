...
SPEED_TOLERANCE = 15
CPLD_FAN_PATH = "/sys/bus/platform/devices/as5812_54x_fan/fan"
...
class Fan(FanBase):
    ...
    def get_direction(self):
        ...
        if not self.is_psu_fan:
            ...
            val=self._api_helper.read_txt_file(dir_str)
            #logging.debug('dir_str=%s, val=%s', dir_str, val)
            if val is not None: 
                if val=='F2B':
                    direction=self.FAN_DIRECTION_EXHAUST
                else:
    ...
    def get_presence(self):
        ...
        if self.is_psu_fan:
            ...
            present_path = "{}{}{}".format(CPLD_FAN_PATH, self.fan_tray_index+1, '_speed_rpm')
    ...
    def get_status(self):
        ...
        if self.is_psu_fan:
            ...
            path = "{}{}{}".format(CPLD_FAN_PATH, self.fan_tray_index+1, '_fault')
