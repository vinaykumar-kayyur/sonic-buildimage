...
class SfpUtil(SfpUtilBase):
    ...
    #SFP ports from 0 to 47, QSFP ports from 48 to 55
    PORT_START = 0
    PORT_END = 55
    QPORT_START = 48
    QPORT_END = 55
    #SFP/QSFP EEPROM are located from i2c-81 ~ i2c-136
    EEPROM_OFFSET = 81
    ...
    def get_presence(self, port_num):
        ...
        # SWPLD2 modprs for sfp port 0~31
        # SWPLD3 modprs for sfp port 32~47
        # SWPLD3 modprs for qsfp port 48~55
        if port_num  < 32:
        ...
        try:
            with open("/sys/devices/platform/delta-agv848v1-swpld.0/" + present_path, 'r') as present:
    ...
    def get_low_power_mode(self, port_num):
        ...
        # SWPLD3 for port 49-56
        lpmode_path = "SWPLD3/qsfp_p{}_lpmode".format(port)

        try:
            with open("/sys/devices/platform/delta-agv848v1-swpld.0/" + lpmode_path, 'r') as lpmode:
    ...
    def set_low_power_mode(self, port_num, lpmode):
        ...
        try:
            file = open("/sys/devices/platform/delta-agv848v1-swpld.0/" + lpmode_path, 'r+')
        except IOError as e:
            print ("Error: unable to open file: %s" % str(e))
            return False
    ...
    def reset(self, port_num):
        ...
        try:
            file = open("/sys/devices/platform/delta-agv848v1-swpld.0/" + reset_path, 'r+')
        except IOError as e:
            print ("Error: unable to open file: %s" % str(e))
            return False
