...
#############################################################################
# Asterfusion CX308P-48Y-T SFP Plugin
#
    ...
    def get_presence(self, port_num):
        ...
        with ThriftConnect() as thrift_client:
            if port_num < self.QSFP_PORT_START:
                ...
                presence = thrift_client.pltfm_mgr_sfp_presence_get(port_num + 1 - 8)
        return presence
    ...
    def get_eeprom(self, port_num):
        ...
        with ThriftConnect() as thrift_client:
            if port_num < self.QSFP_PORT_START:
                ...
                #index 60 61 map to 49 50
                eeprom_hex = thrift_client.pltfm_mgr_sfp_info_get(port_num + 1 - 8)
