...
WDT_TIMER_L_BIT_REG = '0xA183'
WDT_TIMER_M_BIT_REG = '0xA182'
WDT_TIMER_H_BIT_REG = '0xA181'

WDT_GET_TIMER_L_BIT_REG = '0xA186'
WDT_GET_TIMER_M_BIT_REG = '0xA185'
WDT_GET_TIMER_H_BIT_REG = '0xA184'
...
class Watchdog(WatchdogBase):
    ...
    def _gettimeout(self):
        ...
        h_bit = self._api_helper.get_cpld_reg_value(
            self.getreg_path, WDT_GET_TIMER_H_BIT_REG)
        m_bit = self._api_helper.get_cpld_reg_value(
            self.getreg_path, WDT_GET_TIMER_M_BIT_REG)
        l_bit = self._api_helper.get_cpld_reg_value(
            self.getreg_path, WDT_GET_TIMER_L_BIT_REG)
