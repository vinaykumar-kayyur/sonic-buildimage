...
class Watchdog(WatchdogBase):
    ...
    def _enable(self):
        ...
        """
        # echo 0x381 0x1 > /sys/devices/platform/e1031.smc/setreg
    ...
    def _disable(self):
        ...
        """
        # echo 0x381 0x0 > /sys/devices/platform/e1031.smc/setreg
    ...
    def _keepalive(self):
        ...
        """
        # echo 0x385 0x1 > /sys/devices/platform/e1031.smc/setreg
