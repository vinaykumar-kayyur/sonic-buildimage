...
NUM_SFP = 54
NUM_COMPONENT = 5
RESET_REGISTER = "0x102"
HOST_REBOOT_CAUSE_PATH = "/host/reboot-cause/"
REBOOT_CAUSE_FILE = "reboot-cause.txt"
PREV_REBOOT_CAUSE_FILE = "previous-reboot-cause.txt"
GETREG_PATH = "/sys/devices/platform/redstone_xp_cpld/getreg"
HOST_CHK_CMD = "docker > /dev/null 2>&1"
STATUS_LED_PATH = "/sys/devices/platform/redstone_xp_cpld/status_led"
...
class Chassis(ChassisBase):
    ...
    def get_reboot_cause(self):
        ...
        hw_reboot_cause = self._api_helper.get_cpld(GETREG_PATH, RESET_REGISTER)
    ...
    def set_status_led(self, color):
        ...
        if not set_status_str:
            return False
        return self._api_helper.write_txt_file(STATUS_LED_PATH, str(set_status_str))
