...
THERMAL_INFO = {
    0: {
        ...
        "i2c_path": "i2c-6/6-0049/hwmon",  # Front-panel temp sensor
    },
    1: {
        "F2B_max": 70,
        "F2B_max_crit": 75,
        ...
        "i2c_path": "i2c-14/14-0048/hwmon",  # CPU temp sensor
    },
    2: {
        "F2B_max": 70,
        "F2B_max_crit": 75,
        ...
        "i2c_path": "i2c-7/7-004a/hwmon",  # ASIC temp sensor
    },
    3: {
        "F2B_max": 50,
        "F2B_max_crit": 55,
        ...
        "B2F_max_crit": 55,
        "postion": "cpu",
        "name": "Rear-panel temp sensor",
        "i2c_path": "i2c-15/15-004e/hwmon",  # Rear-panel temp sensor
    }
}
NULL_VAL = "N/A"
...
class Thermal(ThermalBase):
    ...
    SS_CONFIG_PATH = "/usr/share/sonic/device/x86_64-cel_redstone_xp-r0/sensors.conf"
    ...
    def __init__(self, thermal_index, airflow):
        ...
        self._hwmon_path = os.path.join(self._i2c_hwmon_path, self.__get_hwmon_name(self._i2c_hwmon_path))
