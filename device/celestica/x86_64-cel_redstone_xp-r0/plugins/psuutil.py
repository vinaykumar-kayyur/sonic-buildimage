...
class PsuUtil(PsuBase):
    ...
    def __init__(self):
        ...
        # redstone_xp PSU pin mapping
        self.redstone_xp_psu_gpio = [
    ...
    def __get_gpio_value(self, pinnum):
        gpio_base = self.redstone_xp_psu_gpio[0]['base']
    ...
    def get_psu_status(self, index):
        ...
        raw = self.__get_gpio_value(
            self.redstone_xp_psu_gpio[index]['status'])
        return int(raw, 10) == 1
    ...
    def get_psu_presence(self, index):
        ...
        """
        raw = self.__get_gpio_value(self.redstone_xp_psu_gpio[index]['prs'])
        return int(raw, 10) == 0
