...
class Sfp(SfpBase):
    ...
    def _dom_capability_detect(self):
        ...
        elif self.sfp_type == "SFP_DD_TYPE":
    ...
    def get_transceiver_info(self):
        ...
        transceiver_info_dict = dict.fromkeys(info_dict_keys, NULL_VAL)
    ...
    def get_transceiver_bulk_status(self):
        ...
        ========================================================================
        """
        transceiver_dom_info_dict = dict.fromkeys(dom_dict_keys, NULL_VAL)
    ...
    def get_reset_status(self):
        ...
        if self.sfp_type == OSFP_TYPE:
            ...
            offset = 0
            sfpd_obj = qsfp_dd_Dom()
            dom_channel_status_raw = self._read_eeprom_specific_bytes(
                (offset + QSFP_DD_CHANNL_STATUS_OFFSET), QSFP_DD_CHANNL_STATUS_WIDTH)

            if dom_channel_status_raw is None:
                return False

            dom_channel_status_data = sfpd_obj.parse_dom_channel_status(
                dom_channel_status_raw, 0)
    ...
    def get_lpmode(self):
        ...
        try:
            reg_file = open(
                "/".join([PORT_INFO_PATH, self._port_info_name, "qsfp_lpmode"]))
        except IOError as e:
    ...
    def reset(self):
        ...
        try:
            reg_file = open(
                "/".join([PORT_INFO_PATH, self._port_info_name, "qsfp_resetL"]), "w")
        except IOError as e:
            print("Error: unable to open file: %s" % str(e))
            return False
    ...
    def set_lpmode(self, lpmode):
        ...
        try:
            reg_file = open(
                "/".join([PORT_INFO_PATH, self._port_info_name, "qsfp_lpmode"]), "r+")
        except IOError as e:
            print("Error: unable to open file: %s" % str(e))
            return False
