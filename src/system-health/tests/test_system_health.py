...
def test_hardware_checker():
    ...
    assert checker._info['PSU 6'][HealthChecker.INFO_FIELD_OBJECT_MSG] == 'System power exceeds PSU 6 threshold (100.0w)'
    ...
    assert checker._info['PSU 7'][HealthChecker.INFO_FIELD_OBJECT_MSG] == 'System power exceeds PSU 7 threshold but power_critical_threshold is invalid'
