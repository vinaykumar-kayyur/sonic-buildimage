...
conf_isis_cmd = lambda instance: [conf_cmd, 'router isis %s' % (instance)]
conf_isis_if_cmd = lambda instance, ifname: [conf_cmd, 'interface %s' % (ifname)] 
conf_isis_level_cmd = lambda instance, level: [conf_cmd, 'router isis %s' % (instance)]

isis_data = [
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'net': '49.0001.1040.4400.0249.00'},
                       conf_isis_cmd(100) + ['{}net 49.0001.1040.4400.0249.00']),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'level_capability': 'level-2'},
                       conf_isis_cmd(100) + ['{}is-type level-2']),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'dynamic_hostname': 'true'},
                       conf_isis_cmd(100) + ['{}hostname dynamic'], True),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'dynamic_hostname': 'None'},
                       conf_isis_cmd(100) + ['{}hostname dynamic'], True),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'attach_send': 'true'},
                       conf_isis_cmd(100) + ['{}attached-bit send'], True),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'attach_send': 'None'},
                       conf_isis_cmd(100) + ['{}attached-bit send'], True),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'attach_receive_ignore': 'true'},
                       conf_isis_cmd(100) + ['{}attached-bit receive ignore'], True),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'attach_receive_ignore': 'None'},
                       conf_isis_cmd(100) + ['no attached-bit receive ignore'], True),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'set_overload_bit': 'true'},
                       conf_isis_cmd(100) + ['{}set-overload-bit']),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'lsp_mtu_size': '1500'},
                       conf_isis_cmd(100) + ['{}lsp-mtu 1500']),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'log_adjacency_changes': 'true'},
                       conf_isis_cmd(100) + ['{}log-adjacency-changes']),
        CmdMapTestInfo('ISIS_GLOBAL', '100', {'spf_init_delay': 15,
                                              'spf_short_delay': 15,
                                              'spf_long_delay': 5, 
                                              'spf_hold_down': 15, 
                                              'spf_time_to_learn': 5},
                       conf_isis_cmd(100) + ['{}spf-delay-ietf init-delay 15 short-delay 15 long-delay 5 holddown 15 time-to-learn 5']),

        CmdMapTestInfo('ISIS_LEVEL', '100|level-2', {'lsp_refresh_interval': '4'},
                       conf_isis_level_cmd(100, 'level-2') + ['{}lsp-refresh-interval level-2 4']),
        CmdMapTestInfo('ISIS_LEVEL', '100|level-2', {'lsp_maximum_lifetime': '4'},
                       conf_isis_level_cmd(100, 'level-2') + ['{}max-lsp-lifetime level-2 4']),
        CmdMapTestInfo('ISIS_LEVEL', '100|level-2', {'lsp_generation_interval': '4'},
                       conf_isis_level_cmd(100, 'level-2') + ['{}lsp-gen-interval level-2 4']),
        CmdMapTestInfo('ISIS_LEVEL', '100|level-2', {'spf_minimum_interval': '4'},
                       conf_isis_level_cmd(100, 'level-2') + ['{}spf-interval level-2 4']),
        ...
        CmdMapTestInfo('ISIS_INTERFACE', '100|ethernet2', {'hello_padding': 'None'},
                       conf_isis_if_cmd(100, 'ethernet2') + ['{}isis hello padding'], True),
        CmdMapTestInfo('ISIS_INTERFACE', '100|ethernet2', {'network_type': 'point-to-point'},
                       conf_isis_if_cmd(100, 'ethernet2') + ['{}isis network point-to-point']),
        CmdMapTestInfo('ISIS_INTERFACE', '100|ethernet2', {'authentication_type': 'clear',
