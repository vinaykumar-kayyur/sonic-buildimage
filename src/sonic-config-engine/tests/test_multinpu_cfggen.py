...
class TestMultiNpuCfgGen(TestCase):
    ...
    def test_frontend_asic_portchannels(self):
        ...
        output = json.loads(self.run_script(argument))
        self.assertDictEqual(output, \
                {'PortChannel0002': {'admin_status': 'up', 'min_links': '2', 'mtu': '9100', 'tpid': '0x8100', 'lacp_key': 'auto' , 'mode': 'trunk'},
                 'PortChannel4001': {'admin_status': 'up', 'min_links': '2', 'mtu': '9100', 'tpid': '0x8100', 'lacp_key': 'auto', 'mode': 'trunk'},
                 'PortChannel4002': {'admin_status': 'up', 'min_links': '2', 'mtu': '9100', 'tpid': '0x8100', 'lacp_key': 'auto', 'mode': 'trunk'}})

    def test_backend_asic_portchannels(self):
        argument = ["-m", self.sample_graph, "-p", self.port_config[3], "-n", "asic3", "--var-json", "PORTCHANNEL"]
        output = json.loads(self.run_script(argument))
        self.assertDictEqual(output, \
                {'PortChannel4013': {'admin_status': 'up', 'min_links': '2', 'mtu': '9100', 'tpid': '0x8100', 'lacp_key': 'auto', 'mode': 'trunk'},
                 'PortChannel4014': {'admin_status': 'up', 'min_links': '2', 'mtu': '9100', 'tpid': '0x8100', 'lacp_key': 'auto', 'mode': 'trunk'}})
