...
class TestMultiNpuCfgGen(TestCase):
    ...
    def test_frontend_asic_ports(self):
        ...
        output = json.loads(self.run_script(argument))
        self.assertDictEqual(output,
            {"Ethernet0": { "admin_status": "up",  "alias": "Ethernet1/1",  "asic_port_name": "Eth0-ASIC0",  "description": "01T2:Ethernet1",  "index": "0",  "lanes": "33,34,35,36",  "mtu": "9100", "tpid": "0x8100",  "mode": "trunk", "pfc_asym": "off",  "role": "Ext",  "speed": "40000", "autoneg": "on", "mode": "trunk"  },
             "Ethernet4": { "admin_status": "up",  "alias": "Ethernet1/2",  "asic_port_name": "Eth1-ASIC0",  "description": "01T2:Ethernet2",  "index": "1",  "lanes": "29,30,31,32",  "mtu": "9100", "tpid": "0x8100", "mode": "trunk","pfc_asym": "off",  "role": "Ext",  "speed": "40000", "autoneg": "on", "mode": "trunk" },
             "Ethernet8": { "alias": "Ethernet1/3",  "asic_port_name": "Eth2-ASIC0",  "description": "Ethernet1/3",  "index": "2",  "lanes": "41,42,43,44",  "mtu": "9100", "tpid": "0x8100", "mode": "trunk","pfc_asym": "off",  "role": "Ext",  "speed": "40000", "mode": "trunk"},
             ...
             "Ethernet-BP0": { "admin_status": "up",  "alias": "Eth4-ASIC0",  "asic_port_name": "Eth4-ASIC0",  "description": "ASIC2:Eth0-ASIC2",  "index": "0",  "lanes": "13,14,15,16",  "mtu": "9100", "tpid": "0x8100","mode": "trunk", "pfc_asym": "off",  "role": "Int",  "speed": "40000", "mode": "trunk"},
             "Ethernet-BP4": { "admin_status": "up",  "alias": "Eth5-ASIC0",  "asic_port_name": "Eth5-ASIC0",  "description": "ASIC2:Eth1-ASIC2",  "index": "1",  "lanes": "17,18,19,20",  "mtu": "9100", "tpid": "0x8100","mode": "trunk", "pfc_asym": "off",  "role": "Int",  "speed": "40000", "mode": "trunk"},
             "Ethernet-BP8": { "admin_status": "up",  "alias": "Eth6-ASIC0",  "asic_port_name": "Eth6-ASIC0",  "description": "ASIC3:Eth0-ASIC3",  "index": "2",  "lanes": "21,22,23,24",  "mtu": "9100", "tpid": "0x8100","mode": "trunk", "pfc_asym": "off",  "role": "Int",  "speed": "40000", "mode": "trunk" },
             "Ethernet-BP12": { "admin_status": "up",  "alias": "Eth7-ASIC0",  "asic_port_name": "Eth7-ASIC0",  "description": "ASIC3:Eth1-ASIC3",  "index": "3",  "lanes": "25,26,27,28",  "mtu": "9100", "tpid": "0x8100", "mode": "trunk","pfc_asym": "off",  "role": "Int",  "speed": "40000", "mode": "trunk" }})
