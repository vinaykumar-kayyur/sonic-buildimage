...
class TestCfgGen(TestCase):
    ...
    def test_minigraph_vlan_interfaces(self):
        ...
        output = self.run_script(argument)
        self.assertEqual(output.strip(), "['Vlan1000', ('Vlan1000', '192.168.0.1/27')]")
    ...
    def test_minigraph_portchannel_interfaces(self):
        ...
        output = self.run_script(argument)
        self.assertEqual(output.strip(), "['PortChannel01', ('PortChannel01', 'FC00::71/126'), ('PortChannel01', '10.0.0.56/31')]")
