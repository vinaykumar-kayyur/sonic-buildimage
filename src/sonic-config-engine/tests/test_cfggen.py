...
class TestCfgGen(TestCase):
    ...
    def test_minigraph_extra_ethernet_interfaces(self):
        ...
        self.assertEqual(output.strip(), \
                ...
                "'Ethernet0': {'lanes': '29,30,31,32', 'description': 'Ethernet0', 'mtu': '9100', 'alias': 'fortyGigE0/0', 'admin_status': 'up', 'speed': '10000'}, "
                "'Ethernet4': {'lanes': '25,26,27,28', 'description': 'Ethernet4', 'mtu': '9100', 'alias': 'fortyGigE0/4', 'admin_status': 'up', 'speed': '25000'}, "
                "'Ethernet108': {'alias': 'fortyGigE0/108', 'lanes': '81,82,83,84', 'description': 'Ethernet108', 'mtu': '9100'}, "
                "'Ethernet100': {'alias': 'fortyGigE0/100', 'lanes': '125,126,127,128', 'description': 'Ethernet100', 'mtu': '9100'}, "
                "'Ethernet104': {'alias': 'fortyGigE0/104', 'lanes': '85,86,87,88', 'description': 'Ethernet104', 'mtu': '9100'}, "
                "'Ethernet68': {'alias': 'fortyGigE0/68', 'lanes': '69,70,71,72', 'description': 'Ethernet68', 'mtu': '9100'}, "
                "'Ethernet96': {'alias': 'fortyGigE0/96', 'lanes': '121,122,123,124', 'description': 'Ethernet96', 'mtu': '9100'}, "
                "'Ethernet124': {'alias': 'fortyGigE0/124', 'lanes': '101,102,103,104', 'description': 'Ethernet124', 'mtu': '9100'}, "
                "'Ethernet92': {'alias': 'fortyGigE0/92', 'lanes': '113,114,115,116', 'description': 'Ethernet92', 'mtu': '9100'}, "
                "'Ethernet120': {'alias': 'fortyGigE0/120', 'lanes': '97,98,99,100', 'description': 'Ethernet120', 'mtu': '9100'}, "
                "'Ethernet52': {'alias': 'fortyGigE0/52', 'lanes': '53,54,55,56', 'description': 'Ethernet52', 'mtu': '9100'}, "
                "'Ethernet56': {'alias': 'fortyGigE0/56', 'lanes': '61,62,63,64', 'description': 'Ethernet56', 'mtu': '9100'}, "
                "'Ethernet76': {'alias': 'fortyGigE0/76', 'lanes': '73,74,75,76', 'description': 'Ethernet76', 'mtu': '9100'}, "
                "'Ethernet72': {'alias': 'fortyGigE0/72', 'lanes': '77,78,79,80', 'description': 'Ethernet72', 'mtu': '9100'}, "
                "'Ethernet64': {'alias': 'fortyGigE0/64', 'lanes': '65,66,67,68', 'description': 'Ethernet64', 'mtu': '9100'}, "
                "'Ethernet32': {'alias': 'fortyGigE0/32', 'lanes': '9,10,11,12', 'description': 'Ethernet32', 'mtu': '9100'}, "
                "'Ethernet16': {'alias': 'fortyGigE0/16', 'lanes': '41,42,43,44', 'description': 'Ethernet16', 'mtu': '9100'}, "
                "'Ethernet36': {'alias': 'fortyGigE0/36', 'lanes': '13,14,15,16', 'description': 'Ethernet36', 'mtu': '9100'}, "
                "'Ethernet12': {'lanes': '33,34,35,36', 'description': 'Interface description', 'mtu': '9100', 'alias': 'fortyGigE0/12', 'speed': '100000', 'fec': 'rs'}, "
                "'Ethernet88': {'alias': 'fortyGigE0/88', 'lanes': '117,118,119,120', 'description': 'Ethernet88', 'mtu': '9100'}, "
                "'Ethernet116': {'alias': 'fortyGigE0/116', 'lanes': '93,94,95,96', 'description': 'Ethernet116', 'mtu': '9100'}, "
                "'Ethernet80': {'alias': 'fortyGigE0/80', 'lanes': '105,106,107,108', 'description': 'Ethernet80', 'mtu': '9100'}, "
                "'Ethernet112': {'alias': 'fortyGigE0/112', 'lanes': '89,90,91,92', 'description': 'Ethernet112', 'mtu': '9100'}, "
                "'Ethernet84': {'alias': 'fortyGigE0/84', 'lanes': '109,110,111,112', 'description': 'Ethernet84', 'mtu': '9100'}, "
                "'Ethernet48': {'alias': 'fortyGigE0/48', 'lanes': '49,50,51,52', 'description': 'Ethernet48', 'mtu': '9100'}, "
                "'Ethernet44': {'alias': 'fortyGigE0/44', 'lanes': '17,18,19,20', 'description': 'Ethernet44', 'mtu': '9100'}, "
                "'Ethernet40': {'alias': 'fortyGigE0/40', 'lanes': '21,22,23,24', 'description': 'Ethernet40', 'mtu': '9100'}, "
                "'Ethernet28': {'alias': 'fortyGigE0/28', 'lanes': '1,2,3,4', 'description': 'Ethernet28', 'mtu': '9100'}, "
                "'Ethernet60': {'alias': 'fortyGigE0/60', 'lanes': '57,58,59,60', 'description': 'Ethernet60', 'mtu': '9100'}, "
                "'Ethernet20': {'alias': 'fortyGigE0/20', 'lanes': '45,46,47,48', 'description': 'Ethernet20', 'mtu': '9100'}, "
                "'Ethernet24': {'alias': 'fortyGigE0/24', 'lanes': '5,6,7,8', 'description': 'Ethernet24', 'mtu': '9100'}}")
