    ...
    def test_minigraph_neighbor_interfaces_config_db(self):
        ...
        self.assertEqual(
            ...
            utils.to_dict(
                ...
                "'Ethernet1': {'lanes': '200', 'description': 'Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/1': {'lanes': '201', 'description': 'Ethernet1/1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/2': {'lanes': '202', 'description': 'Ethernet1/2', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/3': {'lanes': '203', 'description': 'Ethernet1/3', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/4': {'lanes': '204', 'description': 'Ethernet1/4', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/5': {'lanes': '205', 'description': 'Ethernet1/5', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/6': {'lanes': '206', 'description': 'Ethernet1/6', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/7': {'lanes': '207', 'description': 'Ethernet1/7', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, "
                "'Ethernet1/8': {'lanes': '208', 'description': 'Ethernet1/8', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}}"
            )
        )
