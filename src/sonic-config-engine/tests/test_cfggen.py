...
#         self.assertEqual(output.strip(), "{'everflow0': {'src_ip': '10.1.0.32', 'dst_ip': '2.2.2.2'}}")
    ...
    def test_minigraph_portchannel_with_more_member(self):
        ...
        self.assertEqual(
            utils.to_dict(output.strip()),
            utils.to_dict("{'PortChannel01': {'admin_status': 'up', 'min_links': '3', 'mtu': '9100','tpid': '0x8100', 'mode': 'routed', 'lacp_key': 'auto'}}"))
    ...
    def test_minigraph_ethernet_interfaces(self, **kwargs):
        ...
        self.assertEqual(
            utils.to_dict(output.strip()),
            utils.to_dict("{'lanes': '33,34,35,36', 'fec': 'rs', 'pfc_asym': 'off', 'mtu': '9100', 'tpid': '0x8100','mode': 'routed', 'alias': 'fortyGigE0/12', 'admin_status': 'up', 'speed': '100000', 'description': 'Interface description'}")
        )
