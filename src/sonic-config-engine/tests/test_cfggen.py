...
class TestCfgGen(TestCase):
    ...
    def setUp(self):
        ...
        self.sample_mellanox_4700_t0_200_port_config = os.path.join(self.test_dir, 'sample-Mellanox-4700-t0-200-port-config.ini')
        self.sample_mellanox_4700_t0_200_graph = os.path.join(self.test_dir, 'sample-Mellanox-4700-t0-200-minigraph.xml')
...
#         self.assertEqual(output.strip(), "{'everflow0': {'src_ip': '10.1.0.32', 'dst_ip': '10.0.100.1'}}")
    ...
    def test_minigraph_mellanox_t0_200g_with_autoneg(self):
        argument = ["-m", self.sample_mellanox_4700_t0_200_graph, "-p", self.sample_mellanox_4700_t0_200_port_config, "-v", "PORT"]
        self.assertTrue(self.yang.validate(argument))
        output = self.run_script(argument)
        self.assertEqual(
            utils.to_dict(output.strip()),
            utils.to_dict(
                "{'Ethernet0': {'lanes': '0,1,2,3', 'alias': 'etp1a', 'index': '1', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers0:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet4': {'lanes': '4,5,6,7', 'alias': 'etp1b', 'index': '1', 'speed': '200000', 'fec': 'rs', 'description': 'etp1b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet8': {'lanes': '8,9,10,11', 'alias': 'etp2a', 'index': '2', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers1:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet12': {'lanes': '12,13,14,15', 'alias': 'etp2b', 'index': '2', 'speed': '200000', 'fec': 'rs', 'description': 'etp2b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet16': {'lanes': '16,17,18,19', 'alias': 'etp3a', 'index': '3', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers2:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet20': {'lanes': '20,21,22,23', 'alias': 'etp3b', 'index': '3', 'speed': '200000', 'fec': 'rs', 'description': 'etp3b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet24': {'lanes': '24,25,26,27', 'alias': 'etp4a', 'index': '4', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers3:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet28': {'lanes': '28,29,30,31', 'alias': 'etp4b', 'index': '4', 'speed': '200000', 'fec': 'rs', 'description': 'etp4b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet32': {'lanes': '32,33,34,35', 'alias': 'etp5a', 'index': '5', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers4:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet36': {'lanes': '36,37,38,39', 'alias': 'etp5b', 'index': '5', 'speed': '200000', 'fec': 'rs', 'description': 'etp5b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet40': {'lanes': '40,41,42,43', 'alias': 'etp6a', 'index': '6', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers5:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet44': {'lanes': '44,45,46,47', 'alias': 'etp6b', 'index': '6', 'speed': '200000', 'fec': 'rs', 'description': 'etp6b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet48': {'lanes': '48,49,50,51', 'alias': 'etp7a', 'index': '7', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers6:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet52': {'lanes': '52,53,54,55', 'alias': 'etp7b', 'index': '7', 'speed': '200000', 'fec': 'rs', 'description': 'etp7b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet56': {'lanes': '56,57,58,59', 'alias': 'etp8a', 'index': '8', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers7:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet60': {'lanes': '60,61,62,63', 'alias': 'etp8b', 'index': '8', 'speed': '200000', 'fec': 'rs', 'description': 'etp8b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet64': {'lanes': '64,65,66,67', 'alias': 'etp9a', 'index': '9', 'speed': '200000', 'fec': 'rs', 'autoneg': 'on', 'description': 'Servers8:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet68': {'lanes': '68,69,70,71', 'alias': 'etp9b', 'index': '9', 'speed': '200000', 'fec': 'rs', 'description': 'etp9b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet72': {'lanes': '72,73,74,75', 'alias': 'etp10a', 'index': '10', 'speed': '200000', 'fec': 'rs', 'description': 'Servers9:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet76': {'lanes': '76,77,78,79', 'alias': 'etp10b', 'index': '10', 'speed': '200000', 'fec': 'rs', 'description': 'etp10b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet80': {'lanes': '80,81,82,83', 'alias': 'etp11a', 'index': '11', 'speed': '200000', 'fec': 'rs', 'description': 'Servers10:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet84': {'lanes': '84,85,86,87', 'alias': 'etp11b', 'index': '11', 'speed': '200000', 'fec': 'rs', 'description': 'etp11b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet88': {'lanes': '88,89,90,91', 'alias': 'etp12a', 'index': '12', 'speed': '200000', 'fec': 'rs', 'description': 'Servers11:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet92': {'lanes': '92,93,94,95', 'alias': 'etp12b', 'index': '12', 'speed': '200000', 'fec': 'rs', 'description': 'etp12b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet96': {'lanes': '96,97,98,99,100,101,102,103', 'alias': 'etp13', 'index': '13', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA01T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet104': {'lanes': '104,105,106,107,108,109,110,111', 'alias': 'etp14', 'index': '14', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA02T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet112': {'lanes': '112,113,114,115,116,117,118,119', 'alias': 'etp15', 'index': '15', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA03T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet120': {'lanes': '120,121,122,123,124,125,126,127', 'alias': 'etp16', 'index': '16', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA04T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet128': {'lanes': '128,129,130,131,132,133,134,135', 'alias': 'etp17', 'index': '17', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA05T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet136': {'lanes': '136,137,138,139,140,141,142,143', 'alias': 'etp18', 'index': '18', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA06T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet144': {'lanes': '144,145,146,147,148,149,150,151', 'alias': 'etp19', 'index': '19', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA07T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet152': {'lanes': '152,153,154,155,156,157,158,159', 'alias': 'etp20', 'index': '20', 'speed': '400000', 'fec': 'rs', 'description': 'ARISTA08T1:Ethernet1', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet160': {'lanes': '160,161,162,163', 'alias': 'etp21a', 'index': '21', 'speed': '200000', 'fec': 'rs', 'description': 'Servers12:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet164': {'lanes': '164,165,166,167', 'alias': 'etp21b', 'index': '21', 'speed': '200000', 'fec': 'rs', 'description': 'etp21b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet168': {'lanes': '168,169,170,171', 'alias': 'etp22a', 'index': '22', 'speed': '200000', 'fec': 'rs', 'description': 'Servers13:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet172': {'lanes': '172,173,174,175', 'alias': 'etp22b', 'index': '22', 'speed': '200000', 'fec': 'rs', 'description': 'etp22b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet176': {'lanes': '176,177,178,179', 'alias': 'etp23a', 'index': '23', 'speed': '200000', 'fec': 'rs', 'description': 'Servers14:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet180': {'lanes': '180,181,182,183', 'alias': 'etp23b', 'index': '23', 'speed': '200000', 'fec': 'rs', 'description': 'etp23b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet184': {'lanes': '184,185,186,187', 'alias': 'etp24a', 'index': '24', 'speed': '200000', 'fec': 'rs', 'description': 'Servers15:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet188': {'lanes': '188,189,190,191', 'alias': 'etp24b', 'index': '24', 'speed': '200000', 'fec': 'rs', 'description': 'etp24b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet192': {'lanes': '192,193,194,195', 'alias': 'etp25a', 'index': '25', 'speed': '200000', 'fec': 'rs', 'description': 'Servers16:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet196': {'lanes': '196,197,198,199', 'alias': 'etp25b', 'index': '25', 'speed': '200000', 'fec': 'rs', 'description': 'etp25b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet200': {'lanes': '200,201,202,203', 'alias': 'etp26a', 'index': '26', 'speed': '200000', 'fec': 'rs', 'description': 'Servers17:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet204': {'lanes': '204,205,206,207', 'alias': 'etp26b', 'index': '26', 'speed': '200000', 'fec': 'rs', 'description': 'etp26b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet208': {'lanes': '208,209,210,211', 'alias': 'etp27a', 'index': '27', 'speed': '200000', 'fec': 'rs', 'description': 'Servers18:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet212': {'lanes': '212,213,214,215', 'alias': 'etp27b', 'index': '27', 'speed': '200000', 'fec': 'rs', 'description': 'etp27b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet216': {'lanes': '216,217,218,219', 'alias': 'etp28a', 'index': '28', 'speed': '200000', 'fec': 'rs', 'description': 'Servers19:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet220': {'lanes': '220,221,222,223', 'alias': 'etp28b', 'index': '28', 'speed': '200000', 'fec': 'rs', 'description': 'etp28b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet224': {'lanes': '224,225,226,227', 'alias': 'etp29a', 'index': '29', 'speed': '200000', 'fec': 'rs', 'description': 'Servers20:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet228': {'lanes': '228,229,230,231', 'alias': 'etp29b', 'index': '29', 'speed': '200000', 'fec': 'rs', 'description': 'etp29b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet232': {'lanes': '232,233,234,235', 'alias': 'etp30a', 'index': '30', 'speed': '200000', 'fec': 'rs', 'description': 'Servers21:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet236': {'lanes': '236,237,238,239', 'alias': 'etp30b', 'index': '30', 'speed': '200000', 'fec': 'rs', 'description': 'etp30b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet240': {'lanes': '240,241,242,243', 'alias': 'etp31a', 'index': '31', 'speed': '200000', 'fec': 'rs', 'description': 'Servers22:eth0', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off', 'admin_status': 'up'}, 'Ethernet244': {'lanes': '244,245,246,247', 'alias': 'etp31b', 'index': '31', 'speed': '200000', 'fec': 'rs', 'description': 'etp31b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet248': {'lanes': '248,249,250,251', 'alias': 'etp32a', 'index': '32', 'speed': '200000', 'fec': 'rs', 'description': 'etp32a', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}, 'Ethernet252': {'lanes': '252,253,254,255', 'alias': 'etp32b', 'index': '32', 'speed': '200000', 'fec': 'rs', 'description': 'etp32b', 'mtu': '9100', 'tpid': '0x8100', 'pfc_asym': 'off'}}"
