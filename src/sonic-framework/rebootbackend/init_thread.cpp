...
InitThread::InitThread(CriticalStateInterface &critical_interface,
...
swss::StatusCode InitThread::wait_for_state(
    WarmBootStage nsf_stage, swss::SelectableTimer &timer_select) {
...
swss::StatusCode InitThread::handle_state_verification_step() {
  ...
  std::string timestamp =
      send_state_verification_notification(m_db, /*freeze=*/true);
