...
$(info "SONIC_ENABLE_SECUREBOOT_SIGNATURE" : "$(SONIC_ENABLE_SECUREBOOT_SIGNATURE)")
$(info "SIGNING_KEY"                     : "$(SIGNING_KEY)")
$(info "SIGNING_CERT"                    : "$(SIGNING_CERT)")
$(info "SONIC_VENDOR_SIGNING_TOOL"       : "$(SONIC_VENDOR_SIGNING_TOOL)")
ifeq ($(CONFIGURED_PLATFORM),vs)
...
$(addprefix $(TARGET_PATH)/, $(SONIC_INSTALLERS)) : $(TARGET_PATH)/% : \
	...
	$(foreach dep_machine, $($*_MACHINE) $($*_DEPENDENT_MACHINE), \
		...
		SONIC_VENDOR_SIGNING_TOOL="$(SONIC_VENDOR_SIGNING_TOOL)" \
		PACKAGE_URL_PREFIX=$(PACKAGE_URL_PREFIX) \
