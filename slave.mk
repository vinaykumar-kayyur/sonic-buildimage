...
$(foreach IMAGE,$(SONIC_BUSTER_DOCKERS), $(eval $(IMAGE)_DEBS_PATH := $(BUSTER_DEBS_PATH)))
$(foreach IMAGE,$(SONIC_BUSTER_DOCKERS), $(eval $(IMAGE)_FILES_PATH := $(BUSTER_FILES_PATH)))
$(foreach IMAGE,$(SONIC_BUSTER_DBG_DOCKERS), $(eval $(IMAGE)_DEBS_PATH := $(BUSTER_DEBS_PATH)))
$(foreach IMAGE,$(SONIC_BUSTER_DBG_DOCKERS), $(eval $(IMAGE)_FILES_PATH := $(BUSTER_FILES_PATH)))
