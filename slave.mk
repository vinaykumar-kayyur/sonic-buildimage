...
$(addprefix $(TARGET_PATH)/, $(SONIC_INSTALLERS)) : $(TARGET_PATH)/% : \
        ...
        $$(addprefix $(IMAGE_DISTRO_DEBS_PATH)/,$$($$*_LAZY_COMMON_INSTALLS)) \
	...
	export lazy_platform_installer_debs="$(foreach deb, $($*_LAZY_INSTALLS),$(foreach device, $($(deb)_PLATFORM),$(addprefix $(device)@, $(IMAGE_DISTRO_DEBS_PATH)/$(deb))))"
	export lazy_installer_debs="$(foreach deb, $($*_LAZY_COMMON_INSTALLS),$(IMAGE_DISTRO_DEBS_PATH)/$(deb))"
