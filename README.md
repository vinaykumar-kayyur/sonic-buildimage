...
The SONiC installer contains all docker images needed. SONiC uses one image for all switches devices of a same ASIC vendor. The supported ASIC vendors are:
