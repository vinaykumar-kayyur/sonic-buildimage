...
$(DOCKER_FPM_QUAGGA)_WARM_SHUTDOWN_BEFORE = swss
$(DOCKER_FPM_QUAGGA)_WARM_SHUTDOWN_AFTER = radv
$(DOCKER_FPM_QUAGGA)_FAST_SHUTDOWN_BEFORE = swss
$(DOCKER_FPM_QUAGGA)_FAST_SHUTDOWN_AFTER = radv
