...
LIBSENSORS_DEV = libsensors$(LM_SENSORS_DEV_VERSION)-dev_$(LM_SENSORS_VERSION_FULL)_$(CONFIGURED_ARCH).deb
$(eval $(call add_derived_package,$(LM_SENSORS),$(LIBSENSORS_DEV)))
