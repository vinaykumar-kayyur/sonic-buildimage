...
$(SONIC_HOST_SERVICES_PY3)_RSYSLOG_PLUGIN = rsyslog_plugin.py
$($(SONIC_HOST_SERVICES_PY3)_RSYSLOG_PLUGIN)_PATH = $($(SONIC_HOST_SERVICES_PY3)_SRC_PATH)/scripts

SONIC_COPY_FILES += $(SONIC_HOST_SERVICES_PY3)_RSYSLOG_PLUGIN
