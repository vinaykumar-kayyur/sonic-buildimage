...
from ecmp_calc_sdk import sx_open_sdk_connection, sx_get_active_vrids, sx_router_get_ecmp_id, \
                          ...
                          sx_lag_port_group_get, sx_check_rc, sx_make_ip_prefix_v4, \
                          sx_make_ip_prefix_v6, sx_vlan_ports_get, sx_ip_addr_to_str, PORT, VPORT, VLAN
...
def create_network_addr(ip_addr, mask_len, ip_version):
    ...
    network_addr_str = format(network_addr)
