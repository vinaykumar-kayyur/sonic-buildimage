/*
 * A hwmon driver for the FS N8550_48B8C fan
 *
...
extern int fs_i2c_cpld_read(unsigned short cpld_addr, u8 reg);
extern int fs_i2c_cpld_write(unsigned short cpld_addr, u8 reg, u8 value);
...
static int n8550_48b8c_fan_remove(struct i2c_client *client)
{
    struct n8550_48b8c_fan_data *data = i2c_get_clientdata(client);
...
static int __init n8550_48b8c_fan_init(void)
{
    return i2c_add_driver(&n8550_48b8c_fan_driver);
}

static void __exit n8550_48b8c_fan_exit(void)
{
    i2c_del_driver(&n8550_48b8c_fan_driver);
}

module_init(n8550_48b8c_fan_init);
module_exit(n8550_48b8c_fan_exit);
