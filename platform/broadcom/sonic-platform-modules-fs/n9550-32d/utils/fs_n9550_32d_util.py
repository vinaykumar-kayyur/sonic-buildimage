#!/usr/bin/env python3
#
# Copyright (C) 2009-2024 FS.com INC All Rights Reserve.
#
...
'echo n9550_32d_fpga 0x60 > /sys/bus/i2c/devices/i2c-19/new_device',
'echo n9550_32d_cpld1 0x61 > /sys/bus/i2c/devices/i2c-20/new_device',
'echo n9550_32d_cpld2 0x62 > /sys/bus/i2c/devices/i2c-21/new_device',
'echo n9550_32d_cpld_cpu 0x65 > /sys/bus/i2c/devices/i2c-0/new_device',

'echo n9550_32d_fan 0x66 > /sys/bus/i2c/devices/i2c-17/new_device',
...
# PSU-1
'echo n9550_32d_psu1 0x50 > /sys/bus/i2c/devices/i2c-9/new_device',
'echo acbel_fsh082    0x58 > /sys/bus/i2c/devices/i2c-9/new_device',

# PSU-2
'echo n9550_32d_psu2 0x51 > /sys/bus/i2c/devices/i2c-10/new_device',
...
'depmod -ae',
'modprobe i2c_dev',
'modprobe i2c_mux_pca932d force_deselect_on_exit=1',
'modprobe fs_i2c_psu',
'modprobe fs_n9550_32d_cpld',
'modprobe fs_n9550_32d_fan',
'modprobe fs_n9550_32d_leds',
'modprobe fs_n9550_32d_psu',
'modprobe optoe',
'modprobe lm75']
...
def device_install():
    ...
    for i in range(0,len(mknod)):
        #for pca932d need times to built new i2c buses
