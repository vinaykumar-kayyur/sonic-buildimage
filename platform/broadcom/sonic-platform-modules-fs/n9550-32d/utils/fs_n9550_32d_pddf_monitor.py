...
# Deafults
VERSION = '1.0'
FUNCTION_NAME = '/usr/local/bin/fs_n9550_32d_pddf_monitor'
...
def n9550_32d_set_fan_speed(pwm):
    ...
    def manage_fans(self):
        ...
        for i in range(FAN_TRAY_NUM * FAN_NUM):
            if not platform_chassis.get_fan(i).get_status() or not platform_chassis.get_fan(i).get_speed_rpm():
                ...
                if test_temp == 0:
                    ...
                    n9550_32d_set_fan_speed(new_duty_cycle)
        ...
        if current_state != ori_state:
            ...
            if new_duty_cycle == 0 and fan_fail == 0:
                n9550_32d_set_fan_speed(FAN_DUTY_CYCLE_MAX)
