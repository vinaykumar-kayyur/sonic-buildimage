...
'modprobe fs_n5850_48x6c_cpld'  ,
'modprobe ym2651y'                  ,
'modprobe fs_n5850_48x6c_fan'     ,
'modprobe optoe'      ,
'modprobe fs_n5850_48x6c_leds'      ,
'modprobe fs_n5850_48x6c_psu' ]
...
led_prefix ='/sys/class/leds/fs_'+PROJECT_NAME+'_led::'
...
'echo n5850_48x6c_fan 0x63 > /sys/bus/i2c/devices/i2c-3/new_device',
...
'echo n5850_48x6c_psu1 0x50 > /sys/bus/i2c/devices/i2c-11/new_device',
'echo ym2401 0x58 > /sys/bus/i2c/devices/i2c-11/new_device',
'echo n5850_48x6c_psu2 0x53 > /sys/bus/i2c/devices/i2c-12/new_device',
'echo ym2401 0x5b > /sys/bus/i2c/devices/i2c-12/new_device',
'echo n5850_48x6c_cpld1 0x60 > /sys/bus/i2c/devices/i2c-3/new_device',
'echo n5850_48x6c_cpld2 0x61 > /sys/bus/i2c/devices/i2c-3/new_device',
'echo n5850_48x6c_cpld3 0x62 > /sys/bus/i2c/devices/i2c-3/new_device']
