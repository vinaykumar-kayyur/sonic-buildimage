#!/usr/bin/env python
#
# Copyright (C) 2019 FS Technology Corporation
#
...
try:
    ...
    import signal
    from n5850_48s6c.fanutil import FanUtil
    from n5850_48s6c.thermalutil import ThermalUtil
except ImportError as e:
    raise ImportError('%s - required module not found' % str(e))

# Deafults
VERSION = '1.0'
FUNCTION_NAME = 'fs_n5850_48s6c_monitor'
DUTY_MAX = 100
...
class fs_n5850_48s6c_monitor(object):
    # static temp var
    _ori_temp = 0
    _new_perc = 0
...
def main(argv):
    ...
    monitor = fs_n5850_48s6c_monitor(log_file, log_level)
