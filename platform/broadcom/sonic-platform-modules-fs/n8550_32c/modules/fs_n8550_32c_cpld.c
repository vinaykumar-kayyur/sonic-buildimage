 ...
 * This includes the:
 *	 FS n8550-32c CPLD1/CPLD2/CPLD3
 *
 * Based on:
...
struct n8550-32c_cpld_data {
    enum cpld_type   type;
    struct device   *hwmon_dev;
    struct mutex     update_lock;
};

static const struct i2c_device_id n8550-32c_cpld_id[] = {
    { "n8550-32c_cpld1", n8550-32c_cpld1 },
    { "n8550-32c_cpld2", n8550-32c_cpld2 },
    { "n8550-32c_cpld3", n8550-32c_cpld3 },
    { }
};
MODULE_DEVICE_TABLE(i2c, n8550-32c_cpld_id);
...
enum n8550-32c_cpld1_sysfs_attributes {
	CPLD_VERSION,
	ACCESS,
	MODULE_PRESENT_ALL,
	MODULE_RXLOS_ALL,
...
static ssize_t show_version(struct device *dev, struct device_attribute *da,
             char *buf);
static int n8550-32c_cpld_read_internal(struct i2c_client *client, u8 reg);
static int n8550-32c_cpld_write_internal(struct i2c_client *client, u8 reg, u8 value);
...
static struct attribute *n8550-32c_cpld1_attributes[] = {
...
static const struct attribute_group n8550-32c_cpld1_group = {
	.attrs = n8550-32c_cpld1_attributes,
};

static struct attribute *n8550-32c_cpld2_attributes[] = {
    &sensor_dev_attr_version.dev_attr.attr,
    &sensor_dev_attr_access.dev_attr.attr,
	NULL
};

static const struct attribute_group n8550-32c_cpld2_group = {
	.attrs = n8550-32c_cpld2_attributes,
};

static struct attribute *n8550-32c_cpld3_attributes[] = {
    &sensor_dev_attr_version.dev_attr.attr,
    &sensor_dev_attr_access.dev_attr.attr,	
	NULL
};

static const struct attribute_group n8550-32c_cpld3_group = {
	.attrs = n8550-32c_cpld3_attributes,
};
             ...
             char *buf)
{
	...
	struct n8550-32c_cpld_data *data = i2c_get_clientdata(client);

	mutex_lock(&data->update_lock);

    for (i = 0; i < ARRAY_SIZE(regs); i++) {
        status = n8550-32c_cpld_read_internal(client, regs[i]);
             ...
             char *buf)
{
    ...
    status = n8550-32c_cpld_read_internal(client, reg);
			...
			const char *buf, size_t count)
{
    ...
    status = n8550-32c_cpld_write_internal(client, reg, status);
	if (unlikely(status < 0)) {
		goto exit;
	}
			...
			const char *buf, size_t count)
{
	...
	mutex_lock(&data->update_lock);
	status = n8550-32c_cpld_write_internal(client, addr, val);
	if (unlikely(status < 0)) {
		goto exit;
	}
	mutex_unlock(&data->update_lock);
...
static void n8550-32c_cpld_add_client(struct i2c_client *client)
{
...
static void n8550-32c_cpld_remove_client(struct i2c_client *client)
{
 ...
 */
static int n8550-32c_cpld_probe(struct i2c_client *client,
			 const struct i2c_device_id *id)
{
	struct i2c_adapter *adap = to_i2c_adapter(client->dev.parent);
	struct n8550-32c_cpld_data *data;
	int ret = -ENODEV;
	...
	data = kzalloc(sizeof(struct n8550-32c_cpld_data), GFP_KERNEL);
	if (!data) {
		ret = -ENOMEM;
		goto exit;
	}
    ...
    switch (data->type) {
    case n8550-32c_cpld1:
        group = &n8550-32c_cpld1_group;
        break;
    case n8550-32c_cpld2:
        group = &n8550-32c_cpld2_group;
         break;
	case n8550-32c_cpld3:
         group = &n8550-32c_cpld3_group;
        break;
    default:
        break;
    }
    ...
    n8550-32c_cpld_add_client(client);
    return 0;
...
static void n8550-32c_cpld_remove(struct i2c_client *client)
{
    struct n8550-32c_cpld_data *data = i2c_get_clientdata(client);
    const struct attribute_group *group = NULL;

    n8550-32c_cpld_remove_client(client);
...
int n8550-32c_cpld_read(unsigned short cpld_addr, u8 reg)
{
    struct list_head   *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
    int ret = -EPERM;
    ...
    list_for_each(list_node, &cpld_client_list)
    {
        ...
        if (cpld_node->client->addr == cpld_addr) {
            ret = n8550-32c_cpld_read_internal(cpld_node->client, reg);
    		break;
        }
    }
...
EXPORT_SYMBOL(n8550-32c_cpld_read);

int n8550-32c_cpld_write(unsigned short cpld_addr, u8 reg, u8 value)
{
    struct list_head   *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
    int ret = -EIO;
    ...
    list_for_each(list_node, &cpld_client_list)
    {
        ...
        if (cpld_node->client->addr == cpld_addr) {
            ret = n8550-32c_cpld_write_internal(cpld_node->client, reg, value);
            break;
        }
    }
...
EXPORT_SYMBOL(n8550-32c_cpld_write);

static struct i2c_driver n8550-32c_cpld_driver = {
	.driver		= {
		.name	= "n8550-32c_cpld",
		.owner	= THIS_MODULE,
	},
	.probe		= n8550-32c_cpld_probe,
	.remove		= n8550-32c_cpld_remove,
	.id_table	= n8550-32c_cpld_id,
};

static int __init n8550-32c_cpld_init(void)
{
    mutex_init(&list_lock);
    return i2c_add_driver(&n8550-32c_cpld_driver);
}

static void __exit n8550-32c_cpld_exit(void)
{
    i2c_del_driver(&n8550-32c_cpld_driver);
}

MODULE_DESCRIPTION("FS I2C CPLD driver");
MODULE_LICENSE("GPL");

module_init(n8550-32c_cpld_init);
module_exit(n8550-32c_cpld_exit);
