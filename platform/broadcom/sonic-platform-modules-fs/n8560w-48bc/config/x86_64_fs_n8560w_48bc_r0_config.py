...
DEV_MONITOR_PARAM = {
    ...
    "fans": [
        ...
        {
            "name": "fan4",
            "present": {"gettype": "i2c", "bus": 2, "loc": 0x37, "offset": 0x30, "presentbit": 3, "okval": 0},
            "device": [
                {"id": "fan2frue2", "name": "wb_24c02", "bus": 6, "loc": 0x53, "attr": "eeprom"},
            ],
        },
    ],
    "others": [
...
DRIVERLISTS = [
    ...
    {"name": "platform_common dfd_my_type=0x40a9", "delay": 0},
...
OPTOE = [
    {"name": "wb_optoe2", "startbus": 11, "endbus": 58},
    {"name": "wb_optoe1", "startbus": 59, "endbus": 66},
]

INIT_PARAM_PRE = [
    {"loc": "2-0060/hwmon/hwmon*/avs0_vout_max", "value": "900000"},
    {"loc": "2-0060/hwmon/hwmon*/avs0_vout_min", "value": "750000"},
]
INIT_COMMAND_PRE = [
...
INIT_COMMAND = [
    ...
    "i2cset -y -f 1 0x34 0x60 0x0",
    "i2cset -y -f 1 0x34 0x61 0x0",
    "i2cset -y -f 1 0x34 0x62 0x0",
    "i2cset -y -f 1 0x36 0x60 0x0",
    "i2cset -y -f 1 0x36 0x61 0x0",
    "i2cset -y -f 1 0x36 0x62 0x0",
    "i2cset -y -f 2 0x33 0xad 0xad", #yellow off
    "i2cset -y -f 2 0x35 0xad 0xad",
]
...
PLATFORM_E2_CONF = {
    "fan": [
        ...
        {"name": "fan4", "e2_type": "fantlv", "e2_path": "/sys/bus/i2c/devices/6-0053/eeprom"},
    ],
    "psu": [
