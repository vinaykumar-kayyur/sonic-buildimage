/*
 * A hwmon driver for the as5912_i2c_cpld
 *
...
#define DRV_NAME    "as5912_i2c_cpld"
#define NUM_SFP      48
#define NUM_QSFP     6
#define NUM_ALL_PORTS    54
...
struct attrs as5912_port[NUM_SFP_SB_ATTR] = {
...
struct attrs *as5912_qsfp_list[] = {
    &as5912_port[QSFP_PRESENT],
    &as5912_port[QSFP_LP_MODE],
    NULL
};

struct attrs *as5912_sfp_list[] = {
    &as5912_port[SFP_PRESENT],
    &as5912_port[SFP_TX_DIS],
    &as5912_port[SFP_TX_FAULT],
    &as5912_port[SFP_RX_LOS],
    NULL
};

struct model_attrs models_attr[NUM_MODEL] = {
    {.cmn = as5912_cmn_list, .portly=as5912_sfp_list},
    {.cmn = as5912_cmn_list, .portly=as5912_qsfp_list},
    {.cmn = plain_cmn_list,  .portly=NULL},
};

static LIST_HEAD(cpld_client_list);
static struct mutex	 list_lock;
/* Addresses scanned for as5912_i2c_cpld
 */
...
static const struct i2c_device_id as5912_cpld_id[] = {
    { "as5912_cpld1", MDL_CPLD_SFP},
    { "as5912_cpld2", MDL_CPLD_QSFP},
    { },
};
MODULE_DEVICE_TABLE(i2c, as5912_cpld_id);
...
static int as5912_i2c_cpld_probe(struct i2c_client *client,
...
static int as5912_i2c_cpld_remove(struct i2c_client *client)
{
    struct cpld_data *data = i2c_get_clientdata(client);
...
static struct i2c_driver as5912_i2c_cpld_driver = {
    .class        = I2C_CLASS_HWMON,
    .driver = {
        .name = DRV_NAME,
    },
    .probe		= as5912_i2c_cpld_probe,
    .remove	   	= as5912_i2c_cpld_remove,
    .id_table     = as5912_cpld_id,
    .address_list = normal_i2c,
};


static int __init as5912_i2c_cpld_init(void)
{
    mutex_init(&list_lock);
    return i2c_add_driver(&as5912_i2c_cpld_driver);
}

static void __exit as5912_i2c_cpld_exit(void)
{
    i2c_del_driver(&as5912_i2c_cpld_driver);
}

module_init(as5912_i2c_cpld_init);
module_exit(as5912_i2c_cpld_exit);

MODULE_AUTHOR("Roy Lee <roy_lee@accton.com.tw>");
MODULE_DESCRIPTION("as5912_i2c_cpld driver");
MODULE_LICENSE("GPL");
