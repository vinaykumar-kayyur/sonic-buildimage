/*
 * A hwmon driver for the Accton as5912-54x fan control
 *
...
struct attrs as5912_module[NUM_FAN_ATTRS] = {
...
struct attrs *as5912_mod_list[] = {
    &as5912_module[_ENABLE],
    &as5912_module[_PRESENT],
    &as5912_module[_FAULT],
    &as5912_module[_SPEED_RPM],
    &as5912_module[_PWM],
    NULL
};
...
struct model_attrs models_attr = {
    .cmn = as5912_cmn_list,
    .indiv = as5912_mod_list,
};


static const struct i2c_device_id as5912_fan_id[] = {
    { "as5912_fan", 0},
    { },
};
MODULE_DEVICE_TABLE(i2c, as5912_fan_id);
...
static struct i2c_driver as5912_i2c_fan_driver = {
    ...
    .probe		= fan_probe,
    .remove	   	= fan_remove,
    .id_table     = as5912_fan_id,
    .address_list = normal_i2c,
};

static int __init accton_as5912_54x_fan_init(void)
{
    return i2c_add_driver(&as5912_i2c_fan_driver);
}

static void __exit accton_as5912_54x_fan_exit(void)
{
    i2c_del_driver(&as5912_i2c_fan_driver);
}

MODULE_AUTHOR("Brandon Chuang <brandon_chuang@accton.com.tw>");
MODULE_DESCRIPTION("accton_as5912_54x_fan driver");
MODULE_LICENSE("GPL");

module_init(accton_as5912_54x_fan_init);
module_exit(accton_as5912_54x_fan_exit);
