...
'modprobe x86-64-accton-as7926-40xfb-fan',
...
led_prefix ='/sys/devices/platform/as7926_40xfb_led/'+PROJECT_NAME+'_led::'
...
sfp_map =  [33, 34, 37, 38, 41, 42, 45, 46, 49, 50,
...
'echo pca9548 0x74 > /sys/bus/i2c/devices/i2c-28/new_device',
'echo pca9548 0x74 > /sys/bus/i2c/devices/i2c-29/new_device',
'echo pca9548 0x70 > /sys/bus/i2c/devices/i2c-1/new_device',
'echo pca9548 0x74 > /sys/bus/i2c/devices/i2c-73/new_device',
'echo pca9548 0x74 > /sys/bus/i2c/devices/i2c-74/new_device',
'echo as7926_40xfb_cpld2 0x62 > /sys/bus/i2c/devices/i2c-12/new_device',
'echo as7926_40xfb_cpld3 0x63 > /sys/bus/i2c/devices/i2c-13/new_device',
'echo as7926_40xfb_cpld4 0x64 > /sys/bus/i2c/devices/i2c-76/new_device',
]
...
def device_install():
    ...
    for i in range(11, 21):
        status, output =log_os_system("echo 0 > /sys/bus/i2c/devices/13-0063/module_reset_"+str(i), 1)
        if status:
            print(output)
            if FORCE == 0:
                return status
    ...
    for i in range(41, 54):
        status, output =log_os_system("echo 0 > /sys/bus/i2c/devices/76-0064/module_reset_"+str(i), 1)
        if status:
            print(output)
            if FORCE == 0:
                return status
