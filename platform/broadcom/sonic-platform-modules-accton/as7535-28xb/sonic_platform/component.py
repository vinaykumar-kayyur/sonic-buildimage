...
CPLD_PATH_MAPPING = {
    ...
    "FAN_CPLD": "/sys/devices/platform/as7535_28xb_fan/version",
}

FPGA_PATH_MAPPING = {
    "FPGA_MAJOR": "/sys/devices/platform/as7535_28xb_sys/fpga_version"
}
...
class Component(ComponentBase):
    ...
    def __get_fpga_version(self):
        ...
        return "{}".format(fpga_version["FPGA_MAJOR"])
