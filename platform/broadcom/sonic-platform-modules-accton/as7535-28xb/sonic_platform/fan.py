...
FAN_HWMON_I2C_PATH = "/sys/devices/platform/as7535_28xb_fan/fan{}"
PSU_HWMON_I2C_PATH ="/sys/devices/platform/as7535_28xb_psu/psu{}"
...
class Fan(FanBase):
    ...
    def __init__(self, fan_tray_index, fan_index=0, is_psu_fan=False, psu_index=0):
        ...
        if not self.is_psu_fan:
            sysfs_idx = self.fan_index + 1
            self.hwmon_path = FAN_HWMON_I2C_PATH.format(sysfs_idx)
        else:
            self.psu_index = psu_index
            self.hwmon_path = PSU_HWMON_I2C_PATH.format(self.psu_index+1)
    ...
    def get_direction(self):
        ...
        """
        if not self.is_psu_fan:
            dir_str = "{}{}".format(self.hwmon_path, '_dir')
        else: #For PSU
            dir_str = "{}{}".format(self.hwmon_path,'_fan_dir')
    ...
    def get_speed(self):
        ...
        speed = 0
        if self.is_psu_fan:
            psu_fan_path = "{}{}".format(self.hwmon_path, '_fan1_input')
            ...
            input_path = "{}{}".format(self.hwmon_path, '_input')
            input = self._api_helper.read_txt_file(input_path)

            target_path = "{}{}".format(self.hwmon_path, '_target')
    ...
    def get_target_speed(self):
        ...
        if self.is_psu_fan:
            ...
            speed_path = "{}{}".format(self.hwmon_path, '_pwm')
    ...
    def get_presence(self):
        ...
        """
        present_path = "{}{}".format(self.hwmon_path, '_present')
    ...
    def get_status(self):
        ...
        if self.is_psu_fan:
            ...
            path = "{}{}".format(self.hwmon_path, '_fault')
