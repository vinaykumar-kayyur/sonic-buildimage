...
class Sfp(SfpBase):
    ...
    PLATFORM = "x86_64-accton_as7535_28xb-r0"
    HWSKU = "Accton-AS7535-28XB"
    ...
    def _dom_capability_detect(self):
        ...
        if self._detect_sfp_type() is None:
            return None
        ...
        if self.sfp_type == QSFP_TYPE:
            ...
            if qsfp_option_value_raw is None:
                return None
    ...
    def get_transceiver_info(self):
        ...
        if self.sfp_type == OSFP_TYPE:
            ...
            if sfp_vendor_date_raw is None:
                return None
            ...
            if sfp_ext_identifier_raw is None:
                return None
    ...
    def tx_disable(self, tx_disable):
        ...
        if self.sfp_type == QSFP_TYPE:
            ...
            try:
                ...
                # Write to eeprom
                sysfsfile_eeprom = open(self._eeprom_path, "r+b", buffering=0)
