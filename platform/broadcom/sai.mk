LIBSAIBCM_XGS_VERSION = 8.4.2.0
LIBSAIBCM_DNX_VERSION = 7.1.111.1
LIBSAIBCM_XGS_BRANCH_NAME = SAI_8.4.0_GA
LIBSAIBCM_DNX_BRANCH_NAME = REL_7.0_SAI_1.11
LIBSAIBCM_XGS_URL_PREFIX = "https://sonicstorage.blob.core.windows.net/public/sai/sai-broadcom/zitingguo/$(LIBSAIBCM_XGS_VERSION)/$(LIBSAIBCM_XGS_VERSION)/xgs"
