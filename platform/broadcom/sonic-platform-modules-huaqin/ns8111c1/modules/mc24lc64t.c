...
static ssize_t mc24lc64t_read(struct file *filp, struct kobject *kobj, struct bin_attribute *bin_attr,
...
static ssize_t mc24lc64t_write (struct file *filp, struct kobject *kobj, struct bin_attribute *bin_attr,
                            char *buf, loff_t off, size_t count)
{
    struct i2c_client *client = kobj_to_i2c_client(kobj);
    struct mc24lc64t_data *drvdata = i2c_get_clientdata(client);
...
static int mc24lc64t_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
