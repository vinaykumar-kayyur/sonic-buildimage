...
psu_display_name = {
    "PA550I-F": ['CSU550AP-3-500', 'DPS-550AB-39 A', 'GW-CRPS550N2C', 'CSU550AP-3-300', 'DPS-550AB-39 B', 'CSU550AP-3'],
    "PA550I-R": ['CSU550AP-3-501', 'DPS-550AB-40 A', 'GW-CRPS550N2RC']
}
...
devices = {
    ...
    "temps": [
        ...
        },
        {
            ...
            "Temperature": {
                "value": [
                    {"loc": "/sys/bus/i2c/devices/3-004b/hwmon/hwmon*/temp1_input", "way": "sysfs"},
                    {"loc": "/sys/bus/i2c/devices/3-0048/hwmon/hwmon*/temp1_input", "way": "sysfs"},
                ],
                "Min": -10000,
                "Low": 0,
                "High": 55000,
    ...
    "leds": [
        {
            "name": "FRONT_SYS_LED",
            "led_type": "SYS_LED",
            "led": {"loc": "/dev/cpld1", "offset": 0x72, "len": 1, "way": "devfile"},
            "led_attrs": {
        ...
        },
        {
            "name": "FRONT_PSU_LED",
            "led_type": "PSU_LED",
            "led": {"loc": "/dev/cpld1", "offset": 0x73, "len": 1, "way": "devfile"},
            "led_attrs": {
                "off": 0x00, "red_flash": 0x01, "red": 0x02,
                "green_flash": 0x03, "green": 0x04, "amber_flash": 0x05,
                "amber": 0x06, "mask": 0x07
        ...
        },
        {
            "name": "FRONT_FAN_LED",
            "led_type": "FAN_LED",
            "led": {"loc": "/dev/cpld1", "offset": 0x74, "len": 1, "way": "devfile"},
            "led_attrs": {
                "off": 0x00, "red_flash": 0x01, "red": 0x02,
                "green_flash": 0x03, "green": 0x04, "amber_flash": 0x05,
                "amber": 0x06, "mask": 0x07
    ...
    "fans": [
        ...
        },
        {
            "name": "FAN5",
            "airflow": fanairflow,
            "e2loc": {'loc': '/sys/bus/i2c/devices/i2c-20/20-0050/eeprom', 'way': 'sysfs'},
            "present": {"loc": "/sys/wb_plat/fan/fan5/present", "way": "sysfs", "mask": 0x01, "okval": 1},
            "SpeedMin": threshold.FAN_SPEED_MIN,
            "SpeedMax": threshold.FRONT_FAN_SPEED_MAX,
            "led": {"bus": 2, "addr": 0x0d, "offset": 0x3f, "way": "i2c"},
            "led_attrs": {
                "off": 0x00, "red_flash": 0x01, "red": 0x02,
                "green_flash": 0x03, "green": 0x04, "amber_flash": 0x05,
                "amber": 0x06, "mask": 0x07
