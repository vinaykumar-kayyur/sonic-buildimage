...
SONIC_ONE_IMAGE_DNX=sonic-broadcom-dnx.bin
$(eval $(call add_dependent_machine,$(SONIC_ONE_IMAGE),$(SONIC_ONE_IMAGE_DNX)))
$(SONIC_ONE_IMAGE_DNX)_MACHINE=broadcom-dnx

SONIC_INSTALLERS += $(SONIC_ONE_IMAGE_DNX)
