...
# DNX broadcom build
SONIC_ONE_DNX_IMAGE = sonic-broadcom-dnx.bin
$(SONIC_ONE_DNX_IMAGE)_MACHINE = broadcom
$(SONIC_ONE_DNX_IMAGE)_IMAGE_TYPE = onie
$(SONIC_ONE_DNX_IMAGE)_INSTALLS += $(BRCM_OPENNSL_KERNEL)
$(SONIC_ONE_DNX_IMAGE)_INSTALLS += $(PDDF_PLATFORM_MODULE)
$(SONIC_ONE_DNX_IMAGE)_INSTALLS += $(SYSTEMD_SONIC_GENERATOR)
ifeq ($(INSTALL_DEBUG_TOOLS),y)
$(SONIC_ONE_DNX_IMAGE)_DOCKERS += $(SONIC_INSTALL_DOCKER_DBG_IMAGES)
$(SONIC_ONE_DNX_IMAGE)_DOCKERS += $(filter-out $(patsubst %-$(DBG_IMAGE_MARK).gz,%.gz, $(SONIC_INSTALL_DOCKER_DBG_IMAGES)), $(SONIC_INSTALL_DOCKER_IMAGES))
else
$(SONIC_ONE_DNX_IMAGE)_DOCKERS = $(SONIC_INSTALL_DOCKER_IMAGES)
endif

SONIC_INSTALLERS += $(SONIC_ONE_DNX_IMAGE)
