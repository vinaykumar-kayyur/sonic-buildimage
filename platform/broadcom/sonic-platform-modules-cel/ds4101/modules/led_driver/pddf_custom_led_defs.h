...
typedef enum {
    ...
    STATUS_LED_COLOR_AMBER_BLINK_1HZ,
    STATUS_LED_COLOR_AMBER_BLINK_4HZ,
    STATUS_LED_COLOR_GREEN_BLINK_1HZ,
    STATUS_LED_COLOR_GREEN_BLINK_4HZ,
    STATUS_LED_COLOR_ALTERNATE_BLINK_1HZ,
    STATUS_LED_COLOR_ALTERNATE_BLINK_4HZ,
    MAX_LED_STATUS
}LED_STATUS;
