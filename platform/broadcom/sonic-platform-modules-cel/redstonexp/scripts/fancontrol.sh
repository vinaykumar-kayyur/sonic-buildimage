...
MAIN_CONF=/usr/share/sonic/device/x86_64-cel_redstone_xp-r0/fancontrol
...
init() {
    ...
    FANDIR=$([ $((FANDIR_VALUE + 1)) = 1 ] && echo "B2F" || echo "F2B")
    CONF=${MAIN_CONF}-${FANDIR}
    echo $FANDIR > /usr/share/sonic/device/x86_64-cel_redstone_xp-r0/fan_airflow
}
