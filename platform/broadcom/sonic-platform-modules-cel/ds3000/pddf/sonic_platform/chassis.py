...
class Chassis(PddfChassis):
    ...
    def __init__(self, pddf_data=None, pddf_plugin_data=None):
        ...
        try:
            from sonic_platform_pddf_base.pddf_component import PddfComponent  # noqa
        except ImportError:
            # Use custom Component implementation if no pddf_component support
            from sonic_platform.custom_component import Component
