...
CEL_REDSTONE_PLATFORM_MODULE_VERSION = 0.9
...
export CEL_REDSTONE_PLATFORM_MODULE_VERSION
...
CEL_REDSTONE_PLATFORM_MODULE = platform-modules-redstone_$(CEL_REDSTONE_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_REDSTONE_PLATFORM_MODULE)_SRC_PATH = $(PLATFORM_PATH)/sonic-platform-modules-cel
$(CEL_REDSTONE_PLATFORM_MODULE)_DEPENDS += $(LINUX_HEADERS) $(LINUX_HEADERS_COMMON)
$(CEL_REDSTONE_PLATFORM_MODULE)_PLATFORM = x86_64-cel_redstone-r0
SONIC_DPKG_DEBS += $(CEL_REDSTONE_PLATFORM_MODULE)

SONIC_STRETCH_DEBS += $(CEL_DX010_PLATFORM_MODULE)
SONIC_STRETCH_DEBS += $(CEL_REDSTONE_PLATFORM_MODULE)