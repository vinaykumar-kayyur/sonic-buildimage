...
DELTA_AG9032V2_PLATFORM_MODULE_VERSION = 1.1
...
export DELTA_AG9032V2_PLATFORM_MODULE_VERSION
...
DELTA_AG9032V2_PLATFORM_MODULE = platform-modules-ag9032v2_$(DELTA_AG9032V2_PLATFORM_MODULE_VERSION)_amd64.deb
$(DELTA_AG9032V2_PLATFORM_MODULE)_PLATFORM = x86_64-delta_ag9032v2-r0
$(eval $(call add_extra_package,$(DELTA_AG9032V1_PLATFORM_MODULE),$(DELTA_AG9032V2_PLATFORM_MODULE)))
