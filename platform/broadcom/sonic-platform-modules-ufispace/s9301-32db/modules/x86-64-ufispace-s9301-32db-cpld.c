/*
 * A i2c cpld driver for the ufispace_s9301_32db
 *
...
#include "x86-64-ufispace-s9301-32db-cpld.h"
...
enum s9301_cpld_sysfs_attributes {
    /* CPLD1 */
    CPLD_ACCESS_REG,
    CPLD_REGISTER_VAL,
    CPLD_SKU_ID,
    ...
    /* CPLD2 */
    CPLD_QSFP56_MOD_INT_G0,
    CPLD_QSFP56_MOD_INT_G1,
    CPLD_QSFP56_MOD_INT_G2,
    CPLD_QSFPDD_MOD_INT,
    CPLD_QSFP56_PRES_G0,
    CPLD_QSFP56_PRES_G1,
    CPLD_QSFP56_PRES_G2,
    CPLD_QSFPDD_PRES,
    CPLD_QSFP56_FUSE_INT_G0,
    CPLD_QSFP56_FUSE_INT_G1,
    CPLD_QSFP56_FUSE_INT_G2,
    CPLD_QSFPDD_FUSE_INT,
    CPLD_SFP_TXFAULT,
    CPLD_SFP_ABS,
    CPLD_SFP_RXLOS,
    CPLD_QSFP56_MOD_INT_MASK_G0,
    CPLD_QSFP56_MOD_INT_MASK_G1,
    CPLD_QSFP56_MOD_INT_MASK_G2,
    CPLD_QSFPDD_MOD_INT_MASK,
    CPLD_QSFP56_PRES_MASK_G0,
    CPLD_QSFP56_PRES_MASK_G1,
    CPLD_QSFP56_PRES_MASK_G2,
    CPLD_QSFPDD_PRES_MASK,
    CPLD_QSFP56_FUSE_INT_MASK_G0,
    CPLD_QSFP56_FUSE_INT_MASK_G1,
    CPLD_QSFP56_FUSE_INT_MASK_G2,
    CPLD_QSFPDD_FUSE_INT_MASK,
    CPLD_SFP_TXFAULT_MASK,
    CPLD_SFP_ABS_MASK,
    CPLD_SFP_RXLOS_MASK,
    CPLD_QSFP56_MOD_INT_EVENT_G0,
    CPLD_QSFP56_MOD_INT_EVENT_G1,
    CPLD_QSFP56_MOD_INT_EVENT_G2,
    CPLD_QSFPDD_MOD_INT_EVENT,
    CPLD_QSFP56_PRES_EVENT_G0,
    CPLD_QSFP56_PRES_EVENT_G1,
    CPLD_QSFP56_PRES_EVENT_G2,
    CPLD_QSFPDD_PRES_EVENT,
    CPLD_QSFP56_FUSE_INT_EVENT_G0,
    CPLD_QSFP56_FUSE_INT_EVENT_G1,
    CPLD_QSFP56_FUSE_INT_EVENT_G2,
    CPLD_QSFPDD_FUSE_INT_EVENT,
    CPLD_SFP_TXFAULT_EVENT,
    CPLD_SFP_ABS_EVENT,
    CPLD_SFP_RXLOS_EVENT,
    CPLD_QSFP56_RESET_CTRL_G0,
    CPLD_QSFP56_RESET_CTRL_G1,
    CPLD_QSFP56_RESET_CTRL_G2,
    CPLD_QSFPDD_RESET_CTRL,
    CPLD_QSFP56_LP_MODE_G0,
    CPLD_QSFP56_LP_MODE_G1,
    CPLD_QSFP56_LP_MODE_G2,
    CPLD_QSFPDD_LP_MODE,
    CPLD_SFP_TX_DIS,
    CPLD_SFP_RS,
    CPLD_SFP_TS,
...
static const struct i2c_device_id s9301_cpld_id[] = {
    { "s9301_32db_cpld1",  cpld1 },
    { "s9301_32db_cpld2",  cpld2 },
    { "s9301_32db_cpld3",  cpld3 },
    {}
};
...
/* Addresses scanned for s9301_cpld */
...
static SENSOR_DEVICE_ATTR(cpld_10gmux_sel, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_10GMUX_SEL);
...
/* CPLD2 */
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_g0, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_MOD_INT_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_g1, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_MOD_INT_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_g2, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_MOD_INT_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_mod_int, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFPDD_MOD_INT);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_g0, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_PRES_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_g1, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_PRES_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_g2, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_PRES_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_pres, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFPDD_PRES);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_g0, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_FUSE_INT_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_g1, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_FUSE_INT_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_g2, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_FUSE_INT_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_fuse_int, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFPDD_FUSE_INT);
...
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_mask_g0, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_MOD_INT_MASK_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_mask_g1, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_MOD_INT_MASK_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_mask_g2, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_MOD_INT_MASK_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_mod_int_mask, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFPDD_MOD_INT_MASK);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_mask_g0, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_PRES_MASK_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_mask_g1, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_PRES_MASK_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_mask_g2, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_PRES_MASK_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_pres_mask, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFPDD_PRES_MASK);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_mask_g0, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_FUSE_INT_MASK_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_mask_g1, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_FUSE_INT_MASK_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_mask_g2, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFP56_FUSE_INT_MASK_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_fuse_int_mask, S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, CPLD_QSFPDD_FUSE_INT_MASK);
...
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_event_g0, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_MOD_INT_EVENT_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_event_g1, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_MOD_INT_EVENT_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_mod_int_event_g2, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_MOD_INT_EVENT_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_mod_int_event, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFPDD_MOD_INT_EVENT);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_event_g0, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_PRES_EVENT_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_event_g1, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_PRES_EVENT_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_pres_event_g2, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_PRES_EVENT_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_pres_event, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFPDD_PRES_EVENT);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_event_g0, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_FUSE_INT_EVENT_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_event_g1, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_FUSE_INT_EVENT_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_fuse_int_event_g2, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFP56_FUSE_INT_EVENT_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_fuse_int_event, S_IRUGO, \
        read_cpld_callback, NULL, CPLD_QSFPDD_FUSE_INT_EVENT);
...
static SENSOR_DEVICE_ATTR(cpld_qsfp56_reset_ctrl_g0, \
       S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFP56_RESET_CTRL_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_reset_ctrl_g1, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFP56_RESET_CTRL_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_reset_ctrl_g2, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFP56_RESET_CTRL_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_reset_ctrl, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFPDD_RESET_CTRL);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_lp_mode_g0, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFP56_LP_MODE_G0);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_lp_mode_g1, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFP56_LP_MODE_G1);
static SENSOR_DEVICE_ATTR(cpld_qsfp56_lp_mode_g2, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFP56_LP_MODE_G2);
static SENSOR_DEVICE_ATTR(cpld_qsfpdd_lp_mode, \
        S_IWUSR | S_IRUGO, \
        read_cpld_callback, write_cpld_callback, \
        CPLD_QSFPDD_LP_MODE);
...
/* cpld 1 */
static struct attribute *s9301_cpld1_attributes[] = {
...
/* cpld 2 */
static struct attribute *s9301_cpld2_attributes[] = {
    &sensor_dev_attr_cpld_access_register.dev_attr.attr,
    &sensor_dev_attr_cpld_register_value.dev_attr.attr,
    &sensor_dev_attr_cpld_major_ver.dev_attr.attr,
    &sensor_dev_attr_cpld_minor_ver.dev_attr.attr,
    ...
    &sensor_dev_attr_cpld_qsfp56_mod_int_g2.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfpdd_mod_int.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_pres_g0.dev_attr.attr,
    ...
    &sensor_dev_attr_cpld_qsfp56_fuse_int_g1.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_g2.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfpdd_fuse_int.dev_attr.attr,
    ...
    &sensor_dev_attr_cpld_qsfp56_mod_int_mask_g2.dev_attr.attr,
    ...
    &sensor_dev_attr_cpld_qsfp56_pres_mask_g2.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfpdd_pres_mask.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_mask_g0.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_mask_g1.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_mask_g2.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfpdd_fuse_int_mask.dev_attr.attr,
    ...
    &sensor_dev_attr_cpld_qsfp56_mod_int_event_g2.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfpdd_mod_int_event.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_pres_event_g0.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_pres_event_g1.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_pres_event_g2.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfpdd_pres_event.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_event_g0.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_event_g1.dev_attr.attr,
    &sensor_dev_attr_cpld_qsfp56_fuse_int_event_g2.dev_attr.attr,
...
/* cpld 3 */
static struct attribute *s9301_cpld3_attributes[] = {
    &sensor_dev_attr_cpld_access_register.dev_attr.attr,
    &sensor_dev_attr_cpld_register_value.dev_attr.attr,
    &sensor_dev_attr_cpld_major_ver.dev_attr.attr,
    &sensor_dev_attr_cpld_minor_ver.dev_attr.attr,
...
static const struct attribute_group s9301_cpld1_group = {
    .attrs = s9301_cpld1_attributes,
};
/* cpld 2 attributes group */
static const struct attribute_group s9301_cpld2_group = {
    .attrs = s9301_cpld2_attributes,
};
/* cpld 3 attributes group */
static const struct attribute_group s9301_cpld3_group = {
    .attrs = s9301_cpld3_attributes,
};
        ...
        struct device_attribute *da, char *buf)
{
    ...
    switch(attr->index) {
        ...
        case CPLD_MUX_CTRL:
             ...
             break;
        case CPLD_10GMUX_SEL:
             reg = CPLD_10GMUX_SEL_REG;
             break;
        ...
        case CPLD_EVENT_DETECT_CTRL:
             ...
             break;
        case CPLD_QSFP56_MOD_INT_G0:
             reg = CPLD_QSFP56_MOD_INT_G0_REG;
             break;
        case CPLD_QSFP56_MOD_INT_G1:
             reg = CPLD_QSFP56_MOD_INT_G1_REG;
             break;
        case CPLD_QSFP56_MOD_INT_G2:
             reg = CPLD_QSFP56_MOD_INT_G2_REG;
             break;
        case CPLD_QSFPDD_MOD_INT:
             reg = CPLD_QSFPDD_MOD_INT_REG;
             break;
        case CPLD_QSFP56_PRES_G0:
             reg = CPLD_QSFP56_PRES_G0_REG;
             break;
        case CPLD_QSFP56_PRES_G1:
             reg = CPLD_QSFP56_PRES_G1_REG;
             break;
        case CPLD_QSFP56_PRES_G2:
             reg = CPLD_QSFP56_PRES_G2_REG;
             break;
        case CPLD_QSFPDD_PRES:
             reg = CPLD_QSFPDD_PRES_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_G0:
             reg = CPLD_QSFP56_FUSE_INT_G0_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_G1:
             reg = CPLD_QSFP56_FUSE_INT_G1_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_G2:
             reg = CPLD_QSFP56_FUSE_INT_G2_REG;
             break;
        case CPLD_QSFPDD_FUSE_INT:
             reg = CPLD_QSFPDD_FUSE_INT_REG;
             break;
        ...
        case CPLD_SFP_RXLOS:
             ...
             break;
        case CPLD_QSFP56_MOD_INT_MASK_G0:
             reg = CPLD_QSFP56_MOD_INT_MASK_G0_REG;
             break;
        case CPLD_QSFP56_MOD_INT_MASK_G1:
             reg = CPLD_QSFP56_MOD_INT_MASK_G1_REG;
             break;
        case CPLD_QSFP56_MOD_INT_MASK_G2:
             reg = CPLD_QSFP56_MOD_INT_MASK_G2_REG;
             break;
        case CPLD_QSFPDD_MOD_INT_MASK:
             reg = CPLD_QSFPDD_MOD_INT_MASK_REG;
             break;
        case CPLD_QSFP56_PRES_MASK_G0:
             reg = CPLD_QSFP56_PRES_MASK_G0_REG;
             break;
        case CPLD_QSFP56_PRES_MASK_G1:
             reg = CPLD_QSFP56_PRES_MASK_G1_REG;
             break;
        case CPLD_QSFP56_PRES_MASK_G2:
             reg = CPLD_QSFP56_PRES_MASK_G2_REG;
             break;
        case CPLD_QSFPDD_PRES_MASK:
             reg = CPLD_QSFPDD_PRES_MASK_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_MASK_G0:
             reg = CPLD_QSFP56_FUSE_INT_MASK_G0_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_MASK_G1:
             reg = CPLD_QSFP56_FUSE_INT_MASK_G1_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_MASK_G2:
             reg = CPLD_QSFP56_FUSE_INT_MASK_G2_REG;
             break;
        case CPLD_QSFPDD_FUSE_INT_MASK:
             reg = CPLD_QSFPDD_FUSE_INT_MASK_REG;
             break;
        ...
        case CPLD_SFP_RXLOS_MASK:
             ...
             break;
        case CPLD_QSFP56_MOD_INT_EVENT_G0:
             reg = CPLD_QSFP56_MOD_INT_EVENT_G0_REG;
             break;
        case CPLD_QSFP56_MOD_INT_EVENT_G1:
             reg = CPLD_QSFP56_MOD_INT_EVENT_G1_REG;
             break;
        case CPLD_QSFP56_MOD_INT_EVENT_G2:
             reg = CPLD_QSFP56_MOD_INT_EVENT_G2_REG;
             break;
        case CPLD_QSFPDD_MOD_INT_EVENT:
             reg = CPLD_QSFPDD_MOD_INT_EVENT_REG;
             break;
        case CPLD_QSFP56_PRES_EVENT_G0:
             reg = CPLD_QSFP56_PRES_EVENT_G0_REG;
             break;
        case CPLD_QSFP56_PRES_EVENT_G1:
             reg = CPLD_QSFP56_PRES_EVENT_G1_REG;
             break;
        case CPLD_QSFP56_PRES_EVENT_G2:
             reg = CPLD_QSFP56_PRES_EVENT_G2_REG;
             break;
        case CPLD_QSFPDD_PRES_EVENT:
             reg = CPLD_QSFPDD_PRES_EVENT_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_EVENT_G0:
             reg = CPLD_QSFP56_FUSE_INT_EVENT_G0_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_EVENT_G1:
             reg = CPLD_QSFP56_FUSE_INT_EVENT_G1_REG;
             break;
        case CPLD_QSFP56_FUSE_INT_EVENT_G2:
             reg = CPLD_QSFP56_FUSE_INT_EVENT_G2_REG;
             break;
        case CPLD_QSFPDD_FUSE_INT_EVENT:
             reg = CPLD_QSFPDD_FUSE_INT_EVENT_REG;
             break;
        ...
        case CPLD_SFP_RXLOS_EVENT:
             ...
             break;
        case CPLD_QSFP56_RESET_CTRL_G0:
             reg = CPLD_QSFP56_RESET_CTRL_G0_REG;
             break;
        case CPLD_QSFP56_RESET_CTRL_G1:
             reg = CPLD_QSFP56_RESET_CTRL_G1_REG;
             break;
        case CPLD_QSFP56_RESET_CTRL_G2:
             reg = CPLD_QSFP56_RESET_CTRL_G2_REG;
             break;
        case CPLD_QSFPDD_RESET_CTRL:
             reg = CPLD_QSFPDD_RESET_CTRL_REG;
             break;
        case CPLD_QSFP56_LP_MODE_G0:
             reg = CPLD_QSFP56_LP_MODE_G0_REG;
             break;
        case CPLD_QSFP56_LP_MODE_G1:
             reg = CPLD_QSFP56_LP_MODE_G1_REG;
             break;
        case CPLD_QSFP56_LP_MODE_G2:
             reg = CPLD_QSFP56_LP_MODE_G2_REG;
             break;
        case CPLD_QSFPDD_LP_MODE:
             reg = CPLD_QSFPDD_LP_MODE_REG;
             break;
...
static void s9301_cpld_add_client(struct i2c_client *client)
{
...
static void s9301_cpld_remove_client(struct i2c_client *client)
{
...
static struct i2c_driver s9301_cpld_driver = {
    .class      = I2C_CLASS_HWMON,
    .driver = {
        .name = "x86_64_ufispace_s9301_32db_cpld",
    },
    .probe = s9301_cpld_probe,
    .remove = s9301_cpld_remove,
    .id_table = s9301_cpld_id,
    .address_list = cpld_i2c_addr,
};

/* provide cpld register read */
/* cpld_idx indicate the index of cpld device */
int s9301_cpld_read(u8 cpld_idx,
                u8 reg)
{
    struct list_head *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
...
EXPORT_SYMBOL(s9301_cpld_read);

/* provide cpld register write */
/* cpld_idx indicate the index of cpld device */
int s9301_cpld_write(u8 cpld_idx,
                u8 reg,
                u8 value)
{
    struct list_head *list_node = NULL;
...
EXPORT_SYMBOL(s9301_cpld_write);

static int __init s9301_cpld_init(void)
{
    mutex_init(&list_lock);
    return i2c_add_driver(&s9301_cpld_driver);
}

static void __exit s9301_cpld_exit(void)
{
    i2c_del_driver(&s9301_cpld_driver);
}

MODULE_AUTHOR("Leo Lin <leo.yt.lin@ufispace.com>");
MODULE_DESCRIPTION("x86_64_ufispace_s9301_cpld driver");
MODULE_LICENSE("GPL");

module_init(s9301_cpld_init);
module_exit(s9301_cpld_exit);
