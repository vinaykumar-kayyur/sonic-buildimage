...
get_layout_info(void){
    ...
    switch (platform_p->id) {
        ...
        case PLATFORM_TYPE_SEQUOIA_B0:
            gpio_rest_mux = gpio_base + sequoia_b0_gpio_rest_mux;
            ioexp_layout  = sequoia_b0_ioexp_layout;
            port_layout   = sequoia_b0_port_layout;
            ioexp_total   = ARRAY_SIZE(sequoia_b0_ioexp_layout);
            port_total    = ARRAY_SIZE(sequoia_b0_port_layout);
            break;
#endif
#ifdef SWPS_LAVENDER
        case PLATFORM_TYPE_LAVENDER_GA:
        ...
        case PLATFORM_TYPE_COTTONWOOD_LITE:
            gpio_rest_mux = gpio_base + cottonwood_lite_gpio_rest_mux;
            ioexp_layout  = cottonwood_lite_ioexp_layout;
            port_layout   = cottonwood_lite_port_layout;
            ioexp_total   = ARRAY_SIZE(cottonwood_lite_ioexp_layout);
            port_total    = ARRAY_SIZE(cottonwood_lite_port_layout);
            break;
#endif
#ifdef SWPS_MAPLE_GA
        case PLATFORM_TYPE_MAPLE_GA:
