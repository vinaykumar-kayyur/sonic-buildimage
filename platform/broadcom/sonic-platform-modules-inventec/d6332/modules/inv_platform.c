...
static struct i2c_board_info i2c_device_info1[] __initdata = {
        {"pca9548",          0, 0x70, &mux_data_1, 0, 0},       // MUX
};
...
static struct i2c_board_info i2c_device_info3[] __initdata ={
        ...
        {"tmp75",            0, 0x4D, 0, 0 ,0},                 //RearSide Temperature
...
static struct inv_i2c_board_info i2cdev_list[] = {
    ...
    {bus_id(0),  ARRAY_SIZE(i2c_device_info1),  i2c_device_info1 , 0},  //i2c-0 smbus
    {bus_id(2),  ARRAY_SIZE(i2c_device_info2),  i2c_device_info2 , 0},  //mux 0x73 channel 0
    {bus_id(2),  ARRAY_SIZE(i2c_device_info11), i2c_device_info11, 0},  //mux 0x73 channel 0
    {bus_id(3),  ARRAY_SIZE(i2c_device_info3),  i2c_device_info3 , 0},  //mux 0x73 channel 1
    {bus_id(4),  ARRAY_SIZE(i2c_device_info4),  i2c_device_info4 , 0},  //mux 0x70 channel 0
    {bus_id(5),  ARRAY_SIZE(i2c_device_info5),  i2c_device_info5 , 0},  //mux 0x70 channel 1
    {bus_id(6),  ARRAY_SIZE(i2c_device_info6),  i2c_device_info6 , 0},  //mux 0x70 channel 2
    {bus_id(7),  ARRAY_SIZE(i2c_device_info7),  i2c_device_info7 , 0},  //mux 0x70 channel 3
};
