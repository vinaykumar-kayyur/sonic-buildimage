...
class Fan(FanBase):
    ...
    def __init__(self, index, is_psu_fan=False, psu_index=0):
        ...
        if self.__is_psu_fan:
            ...
            self.__presence_attr  = "/sys/class/hwmon/hwmon{}/fan{}_input".format((self.__psu_index + 7), self.__index)
            self.__speed_rpm_attr = "/sys/class/hwmon/hwmon{}/fan{}_input".format((self.__psu_index + 7), self.__index)
