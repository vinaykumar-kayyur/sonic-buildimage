...
class Psu(PsuBase):
    ...
    def __init__(self, index):
        ...
        self.__psu_power_in_attr    = "/sys/class/hwmon/hwmon{}/power1_input".format(self.__index + 7)
        self.__psu_power_out_attr   = "/sys/class/hwmon/hwmon{}/power2_input".format(self.__index + 7)
        self.__psu_voltage_out_attr = "/sys/class/hwmon/hwmon{}/in2_input".format(self.__index + 7)
        self.__psu_current_out_attr = "/sys/class/hwmon/hwmon{}/curr2_input".format(self.__index + 7)
