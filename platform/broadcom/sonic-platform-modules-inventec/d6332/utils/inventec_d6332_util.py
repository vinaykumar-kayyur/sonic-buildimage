...
instantiate = [
'echo inv_eeprom 0x57 > /sys/bus/i2c/devices/i2c-0/new_device'
#'echo inv_cpld 0x33 > /sys/bus/i2c/devices/i2c-0/new_device',
#'echo inv_cpld 0x77 > /sys/bus/i2c/devices/i2c-0/new_device'
]
