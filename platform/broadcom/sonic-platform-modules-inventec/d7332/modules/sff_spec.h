...
typedef enum { QSFP_PAGE0_LOWER = 0xff, 
               QSFP_PAGE0_UPPER = 0, 
               QSFP_PAGE3 = 3 ,
               QSFP_PAGE_01h = 0x01,
               QSFP_PAGE_10h = 0x10,
...
{STATUS, {QSFP_PAGE0_LOWER, 1, 2}},
{INTERRUPT_FLAG, {QSFP_PAGE0_LOWER, 3, 12}},
...
/*qsfp-dd*/
{ID_STATUS_SUMMARY, {QSFP_PAGE0_LOWER, 0, 4}},
{MODULE_FLAGS, {QSFP_PAGE0_LOWER, 8, 1}},
};
