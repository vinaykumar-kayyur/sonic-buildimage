    ...
    "psus": [
        {
            ...
            "device": [
                ...
                {"id": "psu1frue2", "name": "wb_24c02", "bus": 41, "loc": 0x50, "attr": "eeprom"},
            ],
        },
        {
            "name": "psu2",
            ...
            "device": [
                ...
                {"id": "psu2frue2", "name": "wb_24c02", "bus": 42, "loc": 0x50, "attr": "eeprom"},
            ],
        },
    ],
    "fans": [
        {
            ...
            "device": [
                {"id": "fan1frue2", "name": "wb_24c64", "bus": 35, "loc": 0x50, "attr": "eeprom"},
            ],
        },
        {
            "name": "fan2",
            ...
            "device": [
                {"id": "fan2frue2", "name": "wb_24c64", "bus": 34, "loc": 0x50, "attr": "eeprom"},
            ],
        },
        {
            "name": "fan3",
            ...
            "device": [
                {"id": "fan3frue2", "name": "wb_24c64", "bus": 33, "loc": 0x50, "attr": "eeprom"},
            ],
        },
        {
            "name": "fan4",
            ...
            "device": [
                {"id": "fan4frue2", "name": "wb_24c64", "bus":32, "loc": 0x50, "attr": "eeprom"},
            ],
        },
        {
            "name": "fan5",
            ...
            "device": [
                {"id": "fan5frue2", "name": "wb_24c64", "bus": 31, "loc": 0x50, "attr": "eeprom"},
            ],
        },
        {
            "name": "fan6",
            ...
            "device": [
                {"id": "fan6frue2", "name": "wb_24c64", "bus": 30, "loc": 0x50, "attr": "eeprom"},
            ],
        },
    ],
    "others": [
        ...
        },
        {
            "name": "lm75",
            "device": [
                {"id": "lm75_1", "name": "wb_lm75", "bus": 36, "loc": 0x48, "attr": "hwmon"},
                {"id": "lm75_2", "name": "wb_lm75", "bus": 36, "loc": 0x49, "attr": "hwmon"},
                {"id": "lm75_3", "name": "wb_lm75", "bus": 39, "loc": 0x4b, "attr": "hwmon"},
                {"id": "lm75_4", "name": "wb_lm75", "bus": 40, "loc": 0x4e, "attr": "hwmon"},
                {"id": "lm75_5", "name": "wb_lm75", "bus": 40, "loc": 0x4f, "attr": "hwmon"},
            ],
        },
        {
            "name": "mac_bsc",
        ...
        },
        {
            "name":"tmp411",
            "device":[
                {"id":"tmp411_1", "name":"wb_tmp411","bus":39, "loc":0x4c, "attr":"hwmon"},
                {"id":"tmp411_2", "name":"wb_tmp411","bus":40, "loc":0x4c, "attr":"hwmon"},
            ],
        },
        {
            "name": "ina3221",
            "device": [
                {"id": "ina3221_1", "name": "wb_ina3221", "bus": 25, "loc": 0x43, "attr": "hwmon"},
            ],
        },
        {
            "name": "wb_tps53622",
            "device": [
                {"id": "wb_tps53622_1", "name": "wb_tps53622", "bus": 25, "loc": 0x67, "attr": "hwmon"},
                {"id": "wb_tps53622_2", "name": "wb_tps53622", "bus": 25, "loc": 0x6c, "attr": "hwmon"},
            ],
        },
        {
            "name": "wb_ucd90160",
            "device": [
                {"id": "wb_ucd90160_1", "name": "wb_ucd90160", "bus": 24, "loc": 0x5b, "attr": "hwmon"},
                {"id": "wb_ucd90160_2", "name": "wb_ucd90160", "bus": 45, "loc": 0x5b, "attr": "hwmon"},
            ],
        },
    ],
}
        ...
        "func": {
            ...
            "params": {
                ...
                "finally": [
                    ...
                    {"dealtype": "io_wr", "io_addr": 0x94d, "value": 0xff},  # disable 5387
                ],
            },
        },
        "arrt_index": 3,
...
DEVICE = [
    ...
    # fan
    {"name": "wb_24c64", "bus": 30, "loc": 0x50},
    {"name": "wb_24c64", "bus": 31, "loc": 0x50},
    {"name": "wb_24c64", "bus": 32, "loc": 0x50},
    {"name": "wb_24c64", "bus": 33, "loc": 0x50},
    {"name": "wb_24c64", "bus": 34, "loc": 0x50},
    {"name": "wb_24c64", "bus": 35, "loc": 0x50},
    # psu
    {"name": "wb_24c02", "bus": 41, "loc": 0x50},
    {"name": "wb_fsp1200", "bus": 41, "loc": 0x58},
    {"name": "wb_24c02", "bus": 42, "loc": 0x50},
    {"name": "wb_fsp1200", "bus": 42, "loc": 0x58},
    # temp
    {"name": "wb_lm75", "bus": 36, "loc": 0x48},
    {"name": "wb_lm75", "bus": 36, "loc": 0x49},
    {"name": "wb_lm75", "bus": 39, "loc": 0x4b},
    {"name": "wb_tmp411", "bus": 39, "loc": 0x4c},
    {"name": "wb_tmp411", "bus": 40, "loc": 0x4c},
    {"name": "wb_lm75", "bus": 40, "loc": 0x4e},
    {"name": "wb_lm75", "bus": 40, "loc": 0x4f},
    # dcdc
    {"name": "wb_ucd90160", "bus": 24, "loc": 0x5b},
    {"name": "wb_ucd90160", "bus": 45, "loc": 0x5b},
    {"name": "wb_ina3221", "bus": 25, "loc": 0x43},
    {"name": "wb_tps53622", "bus": 25, "loc": 0x67},
    {"name": "wb_tps53622", "bus": 25, "loc": 0x6c},
    #avs
    {"name": "wb_xdpe132g5c", "bus": 43, "loc": 0x5b},
]

OPTOE = [
    {"name": "wb_optoe1", "startbus": 46, "endbus": 69},
    {"name": "wb_optoe3", "startbus": 70, "endbus": 77},
]
