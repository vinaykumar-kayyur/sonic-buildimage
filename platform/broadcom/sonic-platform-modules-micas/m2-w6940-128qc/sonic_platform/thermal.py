...
class Thermal(ThermalBase):
    ...
    def __init__(self, interface_obj, index, thermal_name):

        self.restful = interface_obj
        self.temp_id = thermal_name
    ...
    def get_sensor(self):
        ...
        temp_info['value'] = float(info.get('value', 0)) / 1000
        temp_info['max'] = float(info.get('max', 0)) / 1000
        temp_info['min'] = float(info.get('min', 0)) / 1000
        return temp_info
