...
fanairflow = {
    "intake": ['M6520-FAN-F', 'P2EFAN III-F'],
}
...
fan_display_name = {
    "P2EFAN III-F": ['M6520-FAN-F', 'P2EFAN III-F'],
...
devices = {
    ...
    "temps": [
        ...
        },
        {
            ...
            "temp_id": "TEMP6",
            "Temperature": {
                "value": {"loc": "/sys/bus/i2c/devices/7-0058/hwmon/hwmon*/temp1_input", "way": "sysfs"},
                "Min": -10000,
                "Low": 0,
                "High": 55000,
                "Max": 60000,
        ...
        },
        {
            ...
            "temp_id": "TEMP7",
            "Temperature": {
                "value": {"loc": "/sys/bus/i2c/devices/8-005b/hwmon/hwmon*/temp1_input", "way": "sysfs"},
                "Min": -10000,
                "Low": 0,
                "High": 55000,
                "Max": 60000,
