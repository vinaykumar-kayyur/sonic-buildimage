...
#define AST26_WATCHDOG2_RELOAD_VALUE      (WATCHDOG_ADDR + 0x04)
#define AST26_WATCHDOG2_COUNTER_RST       (WATCHDOG_ADDR + 0x08)
#define AST26_WATCHDOG2_CONTROL           (WATCHDOG_ADDR + 0x0C)
#define AST26_WATCHDOG2_TSR               (WATCHDOG_ADDR + 0x10)
#define AST26_WATCHDOG2_CLEAR_STATUS      (WATCHDOG_ADDR + 0x14)
#define AST26_WATCHDOG2_RESET_FUN_MASK_1  (WATCHDOG_ADDR + 0x1C)
#define AST26_WATCHDOG2_RESET_FUN_MASK_2  (WATCHDOG_ADDR + 0x20)
