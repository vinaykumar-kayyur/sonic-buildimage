...
<<<<<<< HEAD
        ...
        size_t len = strlcpy(str_cfg, str, sizeof(str_cfg));
=======
        strcpy_s(str_cfg, str, DFD_CFG_STR_MAX_LEN - 1);
...
<<<<<<< HEAD
        ...
        size_t len = strlcpy(info_ctrl->fpath, buf_val, sizeof(info_ctrl->fpath));
=======
        strcpy_s(info_ctrl->fpath, buf_val, sizeof(info_ctrl->fpath) - 1);
>>>>>>> e95673d1f2310d6fc3a6468ddda335fb9633be1b
        break;
...
<<<<<<< HEAD
        ...
        size_t len = strlcpy(info_ctrl->str_cons, buf_val, sizeof(info_ctrl->str_cons));
=======
        strcpy_s(info_ctrl->str_cons, buf_val, sizeof(info_ctrl->str_cons) - 1);
>>>>>>> e95673d1f2310d6fc3a6468ddda335fb9633be1b
        break;
