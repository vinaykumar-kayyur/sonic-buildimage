...
monitor = {
    ...
    "temps_threshold": {
        ...
        "INLET_TEMP": {"name": "INLET_TEMP", "warning": 45, "critical": 50, "fix": -1},
    ...
    "fancontrol_para": {
        ...
        "abnormal_pwm": 0xff,
        "warning_pwm": 0xff,
        "temp_invalid_pid_pwm": 0x73,
        "temp_error_pid_pwm": 0x73,
        "temp_fail_num": 3,
        "check_temp_fail": [
        ...
        "fan_absent_fullspeed_num": 2,  # 系统全速转-fan不在位数目
        "rotor_error_fullspeed_num": 3,  # 系统全速转-马达失效数目
