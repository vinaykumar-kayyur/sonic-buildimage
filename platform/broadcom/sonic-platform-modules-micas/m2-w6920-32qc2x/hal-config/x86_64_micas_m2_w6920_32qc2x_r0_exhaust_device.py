...
devices = {
    ...
    "temps": [
        {
            ...
            "temp_id": "TEMP1",
            "Temperature": {
                "value": {"loc": "/sys/bus/i2c/devices/57-004f/hwmon/hwmon*/temp1_input", "way": "sysfs"},
                "Min": -10000,
                "Low": 0,
                "High": 85000,
                "Max": 90000,
        ...
        },
        {
            ...
            "api_name": "ASIC_TEMP",
            "Temperature": {
                "value": {"loc": "/sys/bus/i2c/devices/56-004c/hwmon/hwmon*/temp1_input", "way": "sysfs"},
                "Min": 2000,
                "Low": 10000,
                "High": 100000,
                "Max": 105000,
    ...
    "sfps": {
        ...
        "eeprom_path_key": [65,66,63,64] + list(range(67, 91)) + [93,94,91,92,95,96],
        "optoe_driver_path": "/sys/bus/i2c/devices/i2c-%d/%d-0050/dev_class",
        "optoe_driver_key": [65,66,63,64] + list(range(67, 91)) + [93,94,91,92,95,96],
        "reset_cpld": {
            "dev_id": {
                2: {
                    "offset": {
