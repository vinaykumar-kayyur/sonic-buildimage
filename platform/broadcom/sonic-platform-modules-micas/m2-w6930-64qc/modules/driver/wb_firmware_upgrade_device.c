...
static firmware_upgrade_device_t firmware_upgrade_device_data1 = {
    ...
    .en_logic_addr[0]    = 0x18,
    .en_logic_mask[0]    = 0xf8,
    .en_logic_en_val[0]  = 0x04,
...
static firmware_upgrade_device_t firmware_upgrade_device_data3 = {
    ...
    .en_logic_addr[0]    = 0x18,
    .en_logic_mask[0]    = 0xf8,
    .en_logic_en_val[0]  = 0x02,
    .en_logic_dis_val[0] = 0x0,
    .en_logic_width[0]   = 0x1,
    .en_logic_dev[1]     = "/dev/cpld1",
    .en_logic_addr[1]    = 0x46,
    .en_logic_mask[1]    = 0xf0,
    .en_logic_en_val[1]  = 0xfd,
    .en_logic_dis_val[1] = 0xff,
...
static firmware_upgrade_device_t firmware_upgrade_device_data4 = {
    ...
    .en_logic_addr[0]    = 0x18,
    .en_logic_mask[0]    = 0xf8,
    .en_logic_en_val[0]  = 0x03,
    .en_logic_dis_val[0] = 0x0,
    .en_logic_width[0]   = 0x1,
    .en_logic_dev[1]     = "/dev/cpld1",
    .en_logic_addr[1]    = 0x46,
    .en_logic_mask[1]    = 0xf0,
    .en_logic_en_val[1]  = 0xf7,
    .en_logic_dis_val[1] = 0xff,
    .en_logic_width[1]   = 0x1,
...
static firmware_upgrade_device_t firmware_upgrade_device_data8 = {
    ...
    .en_logic_addr[0]   = 0x18,
    .en_logic_mask[0]   = 0xf8,
    .en_logic_en_val[0] = 0x06,
    .en_logic_dis_val[0]= 0x00,
    .en_logic_width[0]  = 1,

    .en_logic_dev[1]    = "/dev/cpld1",
    .en_logic_addr[1]   = 0x43,
    .en_logic_mask[1]   = 0xfe,
    .en_logic_en_val[1] = 0x00,
    .en_logic_dis_val[1]= 0x01,
    .en_logic_width[1]  = 1,
