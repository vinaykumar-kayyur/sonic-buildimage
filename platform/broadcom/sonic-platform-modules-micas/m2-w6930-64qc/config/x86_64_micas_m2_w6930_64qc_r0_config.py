...
DEV_MONITOR_PARAM = {
    ...
    "psus": [
        {"name": "psu1",
         ...
         "device": [
             ...
             {"id": "psu1frue2", "name": "wb_24c02", "bus": 83, "loc": 0x50, "attr": "eeprom"},
         ],
         },
        {"name": "psu2",
         ...
         "device": [
             ...
             {"id": "psu2frue2", "name": "wb_24c02", "bus": 84, "loc": 0x50, "attr": "eeprom"},
         ],
         },
        {"name": "psu3",
         ...
         "device": [
             ...
             {"id": "psu3frue2", "name": "wb_24c02", "bus": 86, "loc": 0x50, "attr": "eeprom"},
         ],
         },
        {"name": "psu4",
         ...
         "device": [
             ...
             {"id": "psu4frue2", "name": "wb_24c02", "bus": 85, "loc": 0x50, "attr": "eeprom"},
         ],
         },
    ],
    "fans": [
    ...
    "others": [
        ...
        },
        {
            "name": "lm75",
            "device": [
                {"id": "lm75_1", "name": "wb_lm75", "bus": 79, "loc": 0x4b, "attr": "hwmon"},
                {"id": "lm75_2", "name": "wb_lm75", "bus": 93, "loc": 0x48, "attr": "hwmon"},
                {"id": "lm75_3", "name": "wb_lm75", "bus": 94, "loc": 0x49, "attr": "hwmon"},
                {"id": "lm75_4", "name": "wb_lm75", "bus": 102, "loc": 0x48, "attr": "hwmon"},
                {"id": "lm75_5", "name": "wb_lm75", "bus": 117, "loc": 0x4b, "attr": "hwmon"},
                {"id": "lm75_6", "name": "wb_lm75", "bus": 118, "loc": 0x4f, "attr": "hwmon"},
                {"id": "lm75_7", "name": "wb_lm75", "bus": 198, "loc": 0x4b, "attr": "hwmon"},
            ],
        },
        {
            "name": "mac_bsc",
        ...
        },
        {
            "name":"tmp411",
            "device":[
                {"id":"tmp411_1", "name":"wb_tmp411","bus":119, "loc":0x4c, "attr":"hwmon"},
                {"id":"tmp411_2", "name":"wb_tmp411","bus":120, "loc":0x4c, "attr":"hwmon"},
            ],
        },
        {
            "name": "ina3221",
            "device": [
                {"id": "ina3221_1", "name": "wb_ina3221", "bus": 78, "loc": 0x43, "attr": "hwmon"},
            ],
        },
        {
            "name": "wb_tps53622",
            "device": [
                {"id": "wb_tps53622_1", "name": "wb_tps53622", "bus": 78, "loc": 0x67, "attr": "hwmon"},
                {"id": "wb_tps53622_2", "name": "wb_tps53622", "bus": 78, "loc": 0x6c, "attr": "hwmon"},
                {"id": "wb_tps53622_3", "name": "wb_tps53622", "bus": 131, "loc": 0x67, "attr": "hwmon"},
            ],
        },
        {
            "name": "wb_ucd90160",
            "device": [
                {"id": "wb_ucd90160_1", "name": "wb_ucd90160", "bus": 77, "loc": 0x5b, "attr": "hwmon"},
                {"id": "wb_ucd90160_2", "name": "wb_ucd90160", "bus": 128, "loc": 0x5b, "attr": "hwmon"},
                {"id": "wb_ucd90160_3", "name": "wb_ucd90160", "bus": 129, "loc": 0x5b, "attr": "hwmon"},
                {"id": "wb_ucd90160_4", "name": "wb_ucd90160", "bus": 130, "loc": 0x5b, "attr": "hwmon"},
            ],
        },
    ],
}
        ...
        "func": {
            ...
            "params": {
                "before": [
                    ...
                    {"dealtype": "shell", "cmd": "modprobe wb_spi_gpio_device sck=65 miso=32 mosi=67 bus=0"},
...
DEVICE = [
    ...
    # fan
    {"name": "wb_24c64", "bus": 95, "loc": 0x50},
    {"name": "wb_24c64", "bus": 96, "loc": 0x50},
    {"name": "wb_24c64", "bus": 97, "loc": 0x50},
    {"name": "wb_24c64", "bus": 98, "loc": 0x50},
    {"name": "wb_24c64", "bus": 104, "loc": 0x50},
    {"name": "wb_24c64", "bus": 105, "loc": 0x50},
    {"name": "wb_24c64", "bus": 106, "loc": 0x50},
    {"name": "wb_24c64", "bus": 107, "loc": 0x50},
    # psu
    {"name": "wb_24c02", "bus": 83, "loc": 0x50},
    {"name": "wb_fsp1200", "bus": 83, "loc": 0x58},
    {"name": "wb_24c02", "bus": 84, "loc": 0x50},
    {"name": "wb_fsp1200", "bus": 84, "loc": 0x58},
    {"name": "wb_24c02", "bus": 86, "loc": 0x50},
    {"name": "wb_fsp1200", "bus": 86, "loc": 0x58},
    {"name": "wb_24c02", "bus": 85, "loc": 0x50},
    {"name": "wb_fsp1200", "bus": 85, "loc": 0x58},
    # temp
    {"name": "wb_lm75", "bus": 79, "loc": 0x4b},
    {"name": "wb_lm75", "bus": 93, "loc": 0x48},
    {"name": "wb_lm75", "bus": 94, "loc": 0x49},
    {"name": "wb_lm75", "bus": 102, "loc": 0x48},
    {"name": "wb_lm75", "bus": 103, "loc": 0x49},
    {"name": "wb_lm75", "bus": 117, "loc": 0x4b},
    {"name": "wb_lm75", "bus": 118, "loc": 0x4f},
    {"name": "wb_tmp411", "bus": 119, "loc": 0x4c},
    {"name": "wb_tmp411", "bus": 120, "loc": 0x4c},
    {"name": "wb_lm75", "bus": 198, "loc": 0x4b},
    #dcdc
    {"name": "wb_ucd90160", "bus": 77, "loc": 0x5b},
    {"name": "wb_tps53622", "bus": 78, "loc": 0x67},
    {"name": "wb_tps53622", "bus": 78, "loc": 0x6c},
    {"name": "wb_ina3221", "bus": 78, "loc": 0x43},
    {"name": "wb_ucd90160", "bus": 128, "loc": 0x5b},
    {"name": "wb_ucd90160", "bus": 129, "loc": 0x5b},
    {"name": "wb_ucd90160", "bus": 130, "loc": 0x5b},
    {"name": "wb_tps53622", "bus": 131, "loc": 0x67},
    #avs
    {"name": "wb_xdpe132g5c", "bus": 126, "loc": 0x10},
]

OPTOE = [
    {"name": "wb_optoe3", "startbus": 133, "endbus": 196},
]
