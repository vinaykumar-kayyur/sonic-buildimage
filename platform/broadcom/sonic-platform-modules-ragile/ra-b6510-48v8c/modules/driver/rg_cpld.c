...
static SENSOR_DEVICE_ATTR(broad_back_lct, S_IRUGO | S_IWUSR, show_cpld_sysfs_value, set_cpld_sysfs_value, 0x64);
static SENSOR_DEVICE_ATTR(broad_back_sys, S_IRUGO | S_IWUSR, show_cpld_sysfs_value, set_cpld_sysfs_value, 0x72);
static SENSOR_DEVICE_ATTR(psu_status, S_IRUGO, show_cpld_sysfs_value, NULL, 0x51);
static SENSOR_DEVICE_ATTR(broad_front_bmc, S_IRUGO| S_IWUSR, show_cpld_sysfs_value, set_cpld_sysfs_value, 0x71);
...
static SENSOR_DEVICE_ATTR(sfp_presence2, S_IRUGO, show_cpld_sysfs_value, NULL, 0x31);
static SENSOR_DEVICE_ATTR(sfp_presence3, S_IRUGO, show_cpld_sysfs_value, NULL, 0x32);
static SENSOR_DEVICE_ATTR(sfp_presence4, S_IRUGO, show_cpld_sysfs_value, NULL, 0x30);
static SENSOR_DEVICE_ATTR(sfp_presence5, S_IRUGO, show_cpld_sysfs_value, NULL, 0x31);
static SENSOR_DEVICE_ATTR(sfp_presence6, S_IRUGO, show_cpld_sysfs_value, NULL, 0x32);
static SENSOR_DEVICE_ATTR(sfp_presence7, S_IRUGO, show_cpld_sysfs_value, NULL, 0x33);
...
static SENSOR_DEVICE_ATTR(sfp_led_ctrl1, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x90);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl2, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x91);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl3, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x92);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl4, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x93);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl5, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x94);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl6, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x95);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl7, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x96);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl8, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x97);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl9, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x98);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl10, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x99);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl11, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x9a);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl12, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x9b);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl13, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x9c);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl14, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x9d);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl15, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x9e);
static SENSOR_DEVICE_ATTR(sfp_led_ctrl16, S_IRUGO | S_IWUSR ,show_cpld_sysfs_value, set_cpld_sysfs_value, 0x9f);


static struct attribute *cpld_bus1_addr_0x0d_sysfs_attrs[] = {
...
static struct attribute *cpld_bus5_addr_0x0d_sysfs_attrs[] = {
    &sensor_dev_attr_cpld_version.dev_attr.attr,
...
static struct attribute *cpld_bus7_addr_0x30_sysfs_attrs[] = {
    ...
    &sensor_dev_attr_sfp_led_ctrl2.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl3.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl4.dev_attr.attr,
    ...
    &sensor_dev_attr_sfp_led_ctrl9.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl10.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl11.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl12.dev_attr.attr,
    NULL
};

static struct attribute *cpld_bus7_addr_0x31_sysfs_attrs[] = {
    &sensor_dev_attr_mac_led.dev_attr.attr,
    ...
    &sensor_dev_attr_sfp_led_ctrl11.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl12.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl13.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl14.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl15.dev_attr.attr,
    &sensor_dev_attr_sfp_led_ctrl16.dev_attr.attr,
    NULL
};

static const struct attribute_group  cpld_bus1_addr_0x0d_sysfs_group = {
    .attrs = cpld_bus1_addr_0x0d_sysfs_attrs,
};

static const struct attribute_group  cpld_bus5_addr_0x0d_sysfs_group = {
    .attrs = cpld_bus5_addr_0x0d_sysfs_attrs,
};

static const struct attribute_group  cpld_bus7_addr_0x30_sysfs_group = {
    .attrs = cpld_bus7_addr_0x30_sysfs_attrs,
};

static const struct attribute_group  cpld_bus7_addr_0x31_sysfs_group = {
    .attrs = cpld_bus7_addr_0x31_sysfs_attrs,
};
...
static struct cpld_attr_match_group g_cpld_attr_match[] = {
    {1, 0x0d, &cpld_bus1_addr_0x0d_sysfs_group, NULL},
    {5, 0x0d, &cpld_bus5_addr_0x0d_sysfs_group, NULL},
    {7, 0x30, &cpld_bus7_addr_0x30_sysfs_group, NULL},
    {7, 0x31, &cpld_bus7_addr_0x31_sysfs_group, NULL},
};
