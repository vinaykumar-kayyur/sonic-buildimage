...
/* SLOT3 CPLDB */
static platform_i2c_dev_device_t platform_i2c_dev_device_data7 = {
    .i2c_bus = 5,
    .i2c_addr = 0x30,
    .i2c_name = "cpld10",
    .data_bus_width = 1,
...
/* SLOT4 CPLDA */
static platform_i2c_dev_device_t platform_i2c_dev_device_data8 = {
    .i2c_bus = 6,
    .i2c_addr = 0x31,
    .i2c_name = "cpld11",
    .data_bus_width = 1,
...
/* SLOT4 CPLDB */
static platform_i2c_dev_device_t platform_i2c_dev_device_data9 = {
    .i2c_bus = 6,
    .i2c_addr = 0x30,
    .i2c_name = "cpld12",
    .data_bus_width = 1,
...
static struct platform_device platform_i2c_dev_device[] = {
    ...
    },
    {
        ...
        .id = 8,
        .dev    = {
            .platform_data  = &platform_i2c_dev_device_data7,
            .release = wb_platform_i2c_dev_device_release,
        },
    },
    {
        ...
        .id = 9,
        .dev    = {
            .platform_data  = &platform_i2c_dev_device_data8,
            .release = wb_platform_i2c_dev_device_release,
        },
    },
    {
        ...
        .id = 10,
        .dev    = {
            .platform_data  = &platform_i2c_dev_device_data9,
            .release = wb_platform_i2c_dev_device_release,
        },
    },
};
