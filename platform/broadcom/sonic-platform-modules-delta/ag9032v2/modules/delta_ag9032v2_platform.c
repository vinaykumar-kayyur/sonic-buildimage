...
enum ag9032v2_sfp_sysfs_attributes 
{
    SFP_IS_PRESENT,
    QSFP_LPMODE,
    QSFP_RESET,
...
static struct cpld_platform_data ag9032v2_swpld1_platform_data[] = {
    [swpld1] = {
        .reg_addr = SWPLD1_ADDR,
    },
};

static struct cpld_platform_data ag9032v2_swpld2_platform_data[] = {
    [swpld2] = {
        .reg_addr = SWPLD2_ADDR,
    },
};

static struct cpld_platform_data ag9032v2_swpld3_platform_data[] = {
    [swpld3] = {
...
static ssize_t for_status(struct device *dev, struct device_attribute *dev_attr, char *buf){
    ...
    switch (attr->index) {
        case SFP_IS_PRESENT:
            ...
            ret_sfp = (ret & (0x88));
            sfp2_value = (ret_sfp & 0x08) << 3;
            ret_sfp = (ret_sfp & 0x80) | sfp2_value;
...
static struct cpld_mux_platform_data ag9032v2_swpld_mux_platform_data[] = {
    {
        .parent         = BUS1,
...
{
    {
        .name           = "delta-ag9032v2-swpld1-mux",
        .id             = 0,
        .dev            = {
...
static int __init delta_ag9032v2_platform_init(void)
{
//    struct i2c_client *client;
    ...
    swpld_pdata = ag9032v2_swpld1_platform_data;
    for (i = 0; i < ARRAY_SIZE(swpld1_mux_device); i++)
    {
        ...
        if (ret) {
            ...
            goto error_ag9032v2_swpld1_mux;
        }
    }    
...
MODULE_DESCRIPTION("DELTA ag9032v2 Platform Support");
