...
{QSFP_P55_RST, 0x07, 6, 0x01, "\r\n“1” = Normal Operation.\r\n“0” = Reset.\r\n"},
{QSFP_P56_RST, 0x07, 7, 0x01, "\r\n“1” = Normal Operation.\r\n“0” = Reset.\r\n"},
...
{QSFP_P55_MODPRS, 0x08, 6, 0x01, "\r\n“1” = Not Present.\r\n“0” = Present.\r\n"},
{QSFP_P56_MODPRS, 0x08, 7, 0x01, "\r\n“1” = Not Present.\r\n“0” = Present.\r\n"},
...
{QSFP_P55_INTR, 0x09, 6, 0x01, "\r\n“1” = Not Present.\r\n“0” = Present.\r\n"},
{QSFP_P56_INTR, 0x09, 7, 0x01, "\r\n“1” = Not Present.\r\n“0” = Present.\r\n"},
...
{QSFP_P55_LPMODE, 0x0A, 6, 0x01, "\r\n“1” = LP Mode.\r\n“0” = Not LP Mode.\r\n"},
{QSFP_P56_LPMODE, 0x0A, 7, 0x01, "\r\n“1” = LP Mode.\r\n“0” = Not LP Mode.\r\n"},
...
static SENSOR_DEVICE_ATTR(qsfp_p55_rst,     S_IRUGO | S_IWUSR, swpld3_data_show, swpld3_data_store, QSFP_P55_RST);
static SENSOR_DEVICE_ATTR(qsfp_p56_rst,     S_IRUGO | S_IWUSR, swpld3_data_show, swpld3_data_store, QSFP_P56_RST);
/* offset 0x08 */
...
static SENSOR_DEVICE_ATTR(qsfp_p55_modprs,  S_IRUGO,           swpld3_data_show, NULL,              QSFP_P55_MODPRS);
static SENSOR_DEVICE_ATTR(qsfp_p56_modprs,  S_IRUGO,           swpld3_data_show, NULL,              QSFP_P56_MODPRS);
/* offset 0x09 */
...
static SENSOR_DEVICE_ATTR(qsfp_p55_intr,    S_IRUGO,           swpld3_data_show, NULL,              QSFP_P55_INTR);
static SENSOR_DEVICE_ATTR(qsfp_p56_intr,    S_IRUGO,           swpld3_data_show, NULL,              QSFP_P56_INTR);
/* offset 0x0A */
...
static SENSOR_DEVICE_ATTR(qsfp_p55_lpmode,  S_IRUGO | S_IWUSR, swpld3_data_show, swpld3_data_store, QSFP_P55_LPMODE);
static SENSOR_DEVICE_ATTR(qsfp_p56_lpmode,  S_IRUGO | S_IWUSR, swpld3_data_show, swpld3_data_store, QSFP_P56_LPMODE);
/* offset 0x10 */
...
static struct attribute *swpld3_device_attrs[] = {
    ...
    &sensor_dev_attr_qsfp_p55_rst.dev_attr.attr,
    &sensor_dev_attr_qsfp_p56_rst.dev_attr.attr,
    ...
    &sensor_dev_attr_qsfp_p55_modprs.dev_attr.attr,
    &sensor_dev_attr_qsfp_p56_modprs.dev_attr.attr,
    ...
    &sensor_dev_attr_qsfp_p55_intr.dev_attr.attr,
    &sensor_dev_attr_qsfp_p56_intr.dev_attr.attr,
    ...
    &sensor_dev_attr_qsfp_p55_lpmode.dev_attr.attr,
    &sensor_dev_attr_qsfp_p56_lpmode.dev_attr.attr,
...
static struct cpld_platform_data agv848v1_swpld_platform_data[] = {
    [swpld1] = {
...
static struct platform_device swpld_device = {
        .name               = "delta-agv848v1-swpld",
        .id                 = 0,
        .dev                = {
                    .platform_data   = agv848v1_swpld_platform_data,
...
static int __init delta_agv848v1_swpld_init(void)
{
    int ret;

    printk(KERN_INFO "agv848v1_platform_swpld module initialization\n");
    ...
    printk(KERN_INFO "agv848v1_platform_swpld module initialization -- to error \n");
...
static void __exit delta_agv848v1_swpld_exit(void)
{
    platform_device_unregister(&swpld_device);
    platform_driver_unregister(&swpld_driver);
}

module_init(delta_agv848v1_swpld_init);
module_exit(delta_agv848v1_swpld_exit);

MODULE_DESCRIPTION("DNI AGV848V1 SWPLD Platform Support");
