...
#define agv848v1_i2c_device_num(c){                                         \
        .name                   = "delta-agv848v1-i2c-device",                \
        .id                     = c,                                        \
        .dev                    = {                                           \
                    .platform_data = &agv848v1_i2c_device_platform_data[c], \
...
static struct i2c_device_platform_data agv848v1_i2c_device_platform_data[] = {
    {
        /* Fan4 EEPROM (0x50) */
        .parent = 22,
    ...
    },
    {
        /* psu 1 (0x58) */
        .parent = 6,
        .info = { .type = "dni_agv848v1_psu", .addr = 0x58, .platform_data = (void *) 0 },
        .client = NULL,
    },
    {
        /* PSU 2 EEPROM (0x50) */
...
static struct platform_device agv848v1_i2c_device[] = {
    agv848v1_i2c_device_num(0),
    agv848v1_i2c_device_num(1),
    agv848v1_i2c_device_num(2),
    agv848v1_i2c_device_num(3),
    agv848v1_i2c_device_num(4),
    agv848v1_i2c_device_num(5),
    agv848v1_i2c_device_num(6),
    agv848v1_i2c_device_num(7),
    agv848v1_i2c_device_num(8),
    agv848v1_i2c_device_num(9),
    agv848v1_i2c_device_num(10),
    agv848v1_i2c_device_num(11),
    agv848v1_i2c_device_num(12),
    agv848v1_i2c_device_num(13),
    agv848v1_i2c_device_num(14),
    agv848v1_i2c_device_num(15),
};
...
static struct platform_driver i2c_fan_device_driver = {
    ...
    .driver = {
        .owner = THIS_MODULE,
        .name = "delta-agv848v1-i2c-fan-device",
    }
};
...
static struct platform_driver i2c_sfp_main_mux_device_driver = {
    ...
    .driver = {
        .owner = THIS_MODULE,
        .name = "delta-agv848v1-i2c-sfp-main-mux-device",
    }
};
...
static int __init delta_agv848v1_platform_init(void)
{
    ...
    printk("agv848v1_platform module initialization\n");
    ...
    for (cnt = 0; cnt < ARRAY_SIZE(agv848v1_i2c_device); cnt++)
    {
        ret = platform_device_register(&agv848v1_i2c_device[cnt]);
        if (ret) {
            printk(KERN_WARNING "Fail to create i2c device %d\n", cnt);
            goto error_agv848v1_i2c_device;
        }
    }

    return 0;

error_agv848v1_i2c_device:
    for (; cnt >= 0; cnt--) {
        platform_device_unregister(&agv848v1_i2c_device[cnt]);
    }
...
MODULE_DESCRIPTION("DNI agv848v1 Platform Support");
