...
ALPHANETWORKS_SCG60D0_484T_PLATFORM_MODULE_VERSION = 1.0
...
export ALPHANETWORKS_SCG60D0_484T_PLATFORM_MODULE_VERSION
...
ALPHANETWORKS_SCG60D0_484T_PLATFORM_MODULE = sonic-platform-alphanetworks-scg60d0-484t_$(ALPHANETWORKS_SCG60D0_484T_PLATFORM_MODULE_VERSION)_amd64.deb
$(ALPHANETWORKS_SCG60D0_484T_PLATFORM_MODULE)_PLATFORM = x86_64-alphanetworks_scg60d0_484t-r1
$(eval $(call add_extra_package,$(ALPHANETWORKS_SNH60A0_320FV2_PLATFORM_MODULE),$(ALPHANETWORKS_SCG60D0_484T_PLATFORM_MODULE)))
