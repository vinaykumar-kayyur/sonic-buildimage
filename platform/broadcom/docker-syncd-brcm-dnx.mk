...
$(DOCKER_SYNCD_BASE)_DEPENDS += $(SYNCD_DNX)
$(DOCKER_SYNCD_BASE)_FILES += $(DSSERVE) $(BCMCMD)

ifeq ($(INSTALL_DEBUG_TOOLS), y)
$(DOCKER_SYNCD_BASE)_DBG_DEPENDS += $(SYNCD_DNX_DBG) \
                                $(LIBSWSSCOMMON_DBG) \
                                $(LIBSAIMETADATA_DBG) \
                                $(LIBSAIREDIS_DBG)
endif
...
$(DOCKER_SYNCD_BASE)_PACKAGE_NAME = syncd-dnx
$(DOCKER_SYNCD_BASE)_MACHINE = dnx
