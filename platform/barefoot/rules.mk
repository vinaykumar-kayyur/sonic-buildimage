...
# Inject sai into saiserver
#$(SYNCD)_DEPENDS += $(BFN_SAI) $(WNC_OSW1800_PLATFORM) $(BFN_INGRASYS_PLATFORM) $(BFN_PLATFORM)
$(SAISERVER)_DEPENDS += $(BFN_SAI) $(BFN_INGRASYS_PLATFORM) $(BFN_PLATFORM)
#Avoid the parallel build issue as (#5039)
$(SAISERVER)_UNINSTALLS += $(BFN_SAI)
...
# Runtime dependency on sai is set for saiserver
$(SAISERVER)_RDEPENDS += $(BFN_SAI) $(BFN_INGRASYS_PLATFORM) $(BFN_PLATFORM)
