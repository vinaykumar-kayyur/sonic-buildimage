...
class Iface(object):
    ...
    def pltfm_mgr_sfp_get_max_port(self):
        pass

    def pltfm_mgr_sfp_presence_get(self, port_num):
        """
        Parameters:
         - port_num
    ...
    def pltfm_mgr_sfp_info_get(self, port_num):
        """
        Parameters:
         - port_num
    ...
    def pltfm_mgr_bmc_version_get(self):
        pass

    def pltfm_mgr_cpld_info_get(self):
        pass
...
class Client(Iface):
    ...
    def pltfm_mgr_sfp_get_max_port(self):
        self.send_pltfm_mgr_sfp_get_max_port()
        return self.recv_pltfm_mgr_sfp_get_max_port()

    def send_pltfm_mgr_sfp_get_max_port(self):
        self._oprot.writeMessageBegin('pltfm_mgr_sfp_get_max_port', TMessageType.CALL, self._seqid)
        args = pltfm_mgr_sfp_get_max_port_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_pltfm_mgr_sfp_get_max_port(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = pltfm_mgr_sfp_get_max_port_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "pltfm_mgr_sfp_get_max_port failed: unknown result")
    ...
    def pltfm_mgr_sfp_presence_get(self, port_num):
        ...
        """
        self.send_pltfm_mgr_sfp_presence_get(port_num)
        return self.recv_pltfm_mgr_sfp_presence_get()

    def send_pltfm_mgr_sfp_presence_get(self, port_num):
        self._oprot.writeMessageBegin('pltfm_mgr_sfp_presence_get', TMessageType.CALL, self._seqid)
        args = pltfm_mgr_sfp_presence_get_args()
        args.port_num = port_num
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_pltfm_mgr_sfp_presence_get(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = pltfm_mgr_sfp_presence_get_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "pltfm_mgr_sfp_presence_get failed: unknown result")
    ...
    def pltfm_mgr_sfp_info_get(self, port_num):
        ...
        """
        self.send_pltfm_mgr_sfp_info_get(port_num)
        return self.recv_pltfm_mgr_sfp_info_get()

    def send_pltfm_mgr_sfp_info_get(self, port_num):
        self._oprot.writeMessageBegin('pltfm_mgr_sfp_info_get', TMessageType.CALL, self._seqid)
        args = pltfm_mgr_sfp_info_get_args()
        args.port_num = port_num
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_pltfm_mgr_sfp_info_get(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = pltfm_mgr_sfp_info_get_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "pltfm_mgr_sfp_info_get failed: unknown result")
    ...
    def pltfm_mgr_bmc_version_get(self):
        self.send_pltfm_mgr_bmc_version_get()
        return self.recv_pltfm_mgr_bmc_version_get()

    def send_pltfm_mgr_bmc_version_get(self):
        self._oprot.writeMessageBegin('pltfm_mgr_bmc_version_get', TMessageType.CALL, self._seqid)
        args = pltfm_mgr_bmc_version_get_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_pltfm_mgr_bmc_version_get(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = pltfm_mgr_bmc_version_get_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "pltfm_mgr_bmc_version_get failed: unknown result")

    def pltfm_mgr_cpld_info_get(self):
        self.send_pltfm_mgr_cpld_info_get()
        return self.recv_pltfm_mgr_cpld_info_get()

    def send_pltfm_mgr_cpld_info_get(self):
        self._oprot.writeMessageBegin('pltfm_mgr_cpld_info_get', TMessageType.CALL, self._seqid)
        args = pltfm_mgr_cpld_info_get_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_pltfm_mgr_cpld_info_get(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = pltfm_mgr_cpld_info_get_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.ouch is not None:
            raise result.ouch
        raise TApplicationException(TApplicationException.MISSING_RESULT, "pltfm_mgr_cpld_info_get failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["pltfm_mgr_sfp_get_max_port"] = Processor.process_pltfm_mgr_sfp_get_max_port
        self._processMap["pltfm_mgr_sfp_presence_get"] = Processor.process_pltfm_mgr_sfp_presence_get
        self._processMap["pltfm_mgr_sfp_info_get"] = Processor.process_pltfm_mgr_sfp_info_get
        ...
        self._processMap["pltfm_mgr_bmc_version_get"] = Processor.process_pltfm_mgr_bmc_version_get
        self._processMap["pltfm_mgr_cpld_info_get"] = Processor.process_pltfm_mgr_cpld_info_get
    ...
    def process_pltfm_mgr_sfp_get_max_port(self, seqid, iprot, oprot):
        args = pltfm_mgr_sfp_get_max_port_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = pltfm_mgr_sfp_get_max_port_result()
        try:
            result.success = self._handler.pltfm_mgr_sfp_get_max_port()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidPltfmMgrOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("pltfm_mgr_sfp_get_max_port", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_pltfm_mgr_sfp_presence_get(self, seqid, iprot, oprot):
        args = pltfm_mgr_sfp_presence_get_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = pltfm_mgr_sfp_presence_get_result()
        try:
            result.success = self._handler.pltfm_mgr_sfp_presence_get(args.port_num)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidPltfmMgrOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("pltfm_mgr_sfp_presence_get", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_pltfm_mgr_sfp_info_get(self, seqid, iprot, oprot):
        args = pltfm_mgr_sfp_info_get_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = pltfm_mgr_sfp_info_get_result()
        try:
            result.success = self._handler.pltfm_mgr_sfp_info_get(args.port_num)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidPltfmMgrOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("pltfm_mgr_sfp_info_get", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_pltfm_mgr_bmc_version_get(self, seqid, iprot, oprot):
        args = pltfm_mgr_bmc_version_get_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = pltfm_mgr_bmc_version_get_result()
        try:
            result.success = self._handler.pltfm_mgr_bmc_version_get()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidPltfmMgrOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("pltfm_mgr_bmc_version_get", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_pltfm_mgr_cpld_info_get(self, seqid, iprot, oprot):
        args = pltfm_mgr_cpld_info_get_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = pltfm_mgr_cpld_info_get_result()
        try:
            result.success = self._handler.pltfm_mgr_cpld_info_get()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except InvalidPltfmMgrOperation as ouch:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("pltfm_mgr_cpld_info_get", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class pltfm_mgr_pwr_supply_present_get_args(object):
    ...
    def write(self, oprot):
        ...
        if self.ps_num is not None:
            oprot.writeFieldBegin('ps_num', TType.I32, 1)
            oprot.writeI32(self.ps_num)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
pltfm_mgr_pwr_supply_present_get_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'ps_num', None, None, ),  # 1
)
...
class pltfm_mgr_sfp_get_max_port_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_sfp_get_max_port_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_sfp_get_max_port_args)
pltfm_mgr_sfp_get_max_port_args.thrift_spec = (
)


class pltfm_mgr_sfp_get_max_port_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_sfp_get_max_port_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_sfp_get_max_port_result)
pltfm_mgr_sfp_get_max_port_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidPltfmMgrOperation, None], None, ),  # 1
)


class pltfm_mgr_sfp_presence_get_args(object):
    """
    Attributes:
     - port_num
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_sfp_presence_get_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_sfp_presence_get_args)
pltfm_mgr_sfp_presence_get_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'port_num', None, None, ),  # 1
)


class pltfm_mgr_sfp_presence_get_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_sfp_presence_get_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_sfp_presence_get_result)
pltfm_mgr_sfp_presence_get_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidPltfmMgrOperation, None], None, ),  # 1
)


class pltfm_mgr_sfp_info_get_args(object):
    """
    Attributes:
     - port_num
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_sfp_info_get_args')
        if self.port_num is not None:
            oprot.writeFieldBegin('port_num', TType.I32, 1)
            oprot.writeI32(self.port_num)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_sfp_info_get_args)
pltfm_mgr_sfp_info_get_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'port_num', None, None, ),  # 1
)


class pltfm_mgr_sfp_info_get_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_sfp_info_get_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_sfp_info_get_result)
pltfm_mgr_sfp_info_get_result.thrift_spec = (
...
class pltfm_mgr_bmc_version_get_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_bmc_version_get_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_bmc_version_get_args)
pltfm_mgr_bmc_version_get_args.thrift_spec = (
)


class pltfm_mgr_bmc_version_get_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_bmc_version_get_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRING, 0)
            oprot.writeString(self.success.encode('utf-8') if sys.version_info[0] == 2 else self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_bmc_version_get_result)
pltfm_mgr_bmc_version_get_result.thrift_spec = (
    (0, TType.STRING, 'success', 'UTF8', None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidPltfmMgrOperation, None], None, ),  # 1
)


class pltfm_mgr_cpld_info_get_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_cpld_info_get_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_cpld_info_get_args)
pltfm_mgr_cpld_info_get_args.thrift_spec = (
)


class pltfm_mgr_cpld_info_get_result(object):
    """
    Attributes:
     - success
     - ouch
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = pltfm_mgr_cpld_info_t()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('pltfm_mgr_cpld_info_get_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(pltfm_mgr_cpld_info_get_result)
pltfm_mgr_cpld_info_get_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [pltfm_mgr_cpld_info_t, None], None, ),  # 0
    (1, TType.STRUCT, 'ouch', [InvalidPltfmMgrOperation, None], None, ),  # 1
)
