...
function i2c_gpio_init {
    local i=0
    #ABS Port 0-15
    echo "pca9555 0x20" > /sys/bus/i2c/devices/i2c-5/new_device
    #for i in {240..255};
    ...
    #ABS Port 16-31
    echo "pca9555 0x21" > /sys/bus/i2c/devices/i2c-5/new_device
    #for i in {224..239};
    ...
    #INT Port 0-15
    echo "pca9555 0x22" > /sys/bus/i2c/devices/i2c-5/new_device
    #for i in {208..223};
    ...
    #INT Port 16-31
    echo "pca9555 0x23" > /sys/bus/i2c/devices/i2c-5/new_device
    #for i in {192..207};
    ...
    #SFP+
    echo "pca9555 0x27" > /sys/bus/i2c/devices/i2c-5/new_device
    #for i in {176..191};
    ...
    #LP Mode Port 0-15
    echo "pca9555 0x20" > /sys/bus/i2c/devices/i2c-6/new_device
    #for i in {160..175};
    ...
    #LP Mode Port 16-31
    echo "pca9555 0x21" > /sys/bus/i2c/devices/i2c-6/new_device
    #for i in {144..159};
    ...
    #RST Port 0-15
    echo "pca9555 0x22" > /sys/bus/i2c/devices/i2c-6/new_device
    #for i in {128..143};
    ...
    #RST Port 16-31
    echo "pca9555 0x23" > /sys/bus/i2c/devices/i2c-6/new_device
    #for i in {112..127};
...
#TMP75 Init
echo "lm86 0x4c" > /sys/bus/i2c/devices/i2c-41/new_device  # ASIC Coretemp and Front MAC
echo "tmp75 0x4f" > /sys/bus/i2c/devices/i2c-0/new_device #CPU Board
echo "tmp75 0x48" > /sys/bus/i2c/devices/i2c-41/new_device # Near PSU1
echo "tmp75 0x4a" > /sys/bus/i2c/devices/i2c-41/new_device # Rear MAC
echo "tmp75 0x4b" > /sys/bus/i2c/devices/i2c-41/new_device # Near Port 32
echo "tmp75 0x4d" > /sys/bus/i2c/devices/i2c-41/new_device # Near PSU2
