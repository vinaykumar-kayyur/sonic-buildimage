...
ATTR_SHOW_STR_FUNC(debug,
    ...
    "        Output: model name in ASCII.\n"
    "\n"
    "Dump PSU serial number:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x11\n"
    "        Output: serial number in ASCII.\n"
    "\n"
    "Dump PSU vendor:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x12\n"
    "        Output: vendor in ASCII.\n"
    "\n"
    "Dump PSU date:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x14\n"
    "        Format: YYWW in ASCII. Year then week num.\n"
    "\n"
    "Dump PSU part number:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x15\n"
    "        Output: part number in ASCII.\n"
    "\n"
    "Dump PSU hardware version:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x16\n"
    "\n"
    "Dump PSU alarm:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x17\n"
    "        Description: 01=Normal, 00=Has alarm\n"
    "\n"
    "Dump PSU voltage/current thresholds:\n"
    "    $ ipmitool raw 0x34 0x16 <PSU_ID> 0x18\n"
    "    Output format:\n"
    "        OFFSET SIZE FIELD    DESCRIPTION\n"
    "        -----------------------------------------------------\n"
    "        0      3    VIN_MAX  max input voltage in milliVolt\n"
    "        3      3    IIN_MAX  max input current in milliAmpere\n"
    "    NOTE: all numbers are represnted in littel-endian.\n"
)
