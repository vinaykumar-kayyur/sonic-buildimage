...
class Chassis(ChassisBase):
    """
    Marvell platform-specific Chassis class
    """
    reset_reason_dict = {}
    ...
    def __init__(self):
        ...
        #self._eeprom = Eeprom()
        # Construct lists of fans, power supplies, thermal sensors,
        # and other chassis componentsfor i in range(MAX_FAN):
        for i in range(MAX_FAN):
            fan = Fan(i)
