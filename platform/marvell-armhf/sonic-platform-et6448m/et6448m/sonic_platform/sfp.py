...
class Sfp(SfpBase):
    ...
    """
    Marvell platform-specific Sfp class
    """
    ...
    def __init__(self, index, sfp_type, eeprom_path, port_i2c_map):       
        ...
        if smbus_present == 0 :
            ...
            logger.log_info(" Carl PMON - smbus ERROR enable tx- DEBUG    ")
        else :
            bus = smbus.SMBus(0)
            DEVICE_ADDRESS = 0x41
            DEVICEREG = 0x5
    ...
    def get_rx_los(self):
        ...
        if smbus_present == 0:
            logger.log_info(" Carl PMON - smbus ERROR -    ")
    ...
    def get_tx_disable(self):
        ...
        if smbus_present == 0:
            ...
            logger.log_info(" Carl PMON - smbus ERROR  tx- DEBUG    ")
        else :
            bus = smbus.SMBus(0)
            DEVICE_ADDRESS = 0x41
            DEVICEREG = 0x5
    ...
    def get_presence(self):
        ...
        if smbus_present == 0:
            logger.log_info(" Carl PMON - smbus ERROR - DEBUG presence   ")
