...
__attribute__((section("__versions"))) = {
	...
	{ 0x883f4457, __VMLINUX_SYMBOL_STR(pegatron_porsche_cpld_read) },
	...
	{ 0xa9e2399c, __VMLINUX_SYMBOL_STR(pegatron_porsche_cpld_write) },
...
"depends=pegatron_porsche_cpld";

MODULE_ALIAS("i2c:porsche_sfpA");
MODULE_ALIAS("i2c:porsche_sfpB");
MODULE_ALIAS("i2c:porsche_sfpC");
