...
# Platform initialize
KERNEL_MODULE = ['i2c_dev', 'i2c-mux-pca954x force_deselect_on_exit=1', 'at24', 'pegatron_porsche_cpld', 'pegatron_hwmon_mcu', 'pegatron_porsche_psu', 'pegatron_porsche_sfp']
MODULE_ID = ['pca9544', 'pca9544', 'porsche_psu', 'porsche_psu', '24c02', 'pega_hwmon_mcu', 'porsche_cpld', 'porsche_cpld', 'porsche_cpld', 'porsche_sfpA', 'porsche_sfpB', 'porsche_sfpC']
