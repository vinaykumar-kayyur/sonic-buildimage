...
class Sfp(SfpBase):
    ...
    def get_tx_fault(self):
        ...
        #QSFP-DD
            ...
            if self.dom_rx_tx_power_bias_supported: #not implement
                dom_channel_monitor_raw = self._read_eeprom_specific_bytes(QSFP_DD_CHANNL_TX_FAULT_STATUS['offset'], QSFP_DD_CHANNL_TX_FAULT_STATUS['width'],QSFP_DD_CHANNL_TX_FAULT_STATUS['page'])
                if dom_channel_monitor_raw is not None:
