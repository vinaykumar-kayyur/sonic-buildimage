...
GET_HWSKU_CMD = "head -n 1 /usr/share/sonic/device/{}/default_sku"
...
class Chassis(ChassisBase):
    ...
    def _get_sku_name(self):
        ...
        if platform_name == 'UNKNOWN':
            return 'UNKNOWN'
        p = subprocess.Popen(GET_HWSKU_CMD.format(platform_name), shell=True, stdout=subprocess.PIPE)
