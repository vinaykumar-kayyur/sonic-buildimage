...
static SENSOR_DEVICE_ATTR(led_fiber_shift_freq  , S_IRUGO | S_IWUSR , led_fiber_shift_freq_get , led_fiber_shift_freq_set , LED_FIBER_SHIFT_FREQ);
...
static struct attribute *ESQC610_LED_attributes[] =
{
    ...
    &sensor_dev_attr_led_fiber_shift_freq.dev_attr.attr,
    NULL
};
