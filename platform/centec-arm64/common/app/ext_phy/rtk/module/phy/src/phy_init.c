...
int32 cust_get_machine_id(void)
{
    ...
    if (!strncmp(buf, "onie_platform=arm64-micas_m2-w6010-48gt4x-fa-r0",
                     strlen("onie_platform=arm64-micas_m2-w6010-48gt4x-fa-r0"))) {
        cust_cur_dev = DEV_48E4X;
    } else if (!strncmp(buf, "onie_platform=arm64-micas_m2-w6010-48gt4x-ra-r0",
                     strlen("onie_platform=arm64-micas_m2-w6010-48gt4x-ra-r0"))) {
        cust_cur_dev = DEV_48E4X;
    } else {
        cust_cur_dev = DEV_48E4X;  /* invalid device */
    }
    fclose(fp);
