...
static firmware_card_info_t g_card_info[] = {
	{
        .dev_type      = B6510_48VS8CQ,
		.slot_num	   = 1,
		.card_name	   = "B6510-48VS8CQ",
        .gpio_info     = {
            /* slot 0 */
            {
                .tdi       = 32,
	...
	{
        .dev_type      = B6920_4C_V2,
        .slot_num      = 1,
        .card_name     = "B6920-4C-V2",
        .gpio_info     = {
            {
                .tdi       = 7,
                .tck       = 10,
	...
	{
        .dev_type      = B6930_32CDQ2XS,
		.slot_num	   = 1,
		.card_name	   = "B6930-32CDQ2XS",
        .gpio_info     = {
            /* slot 0 */
            {
                .tdi       = 67,
    ...
    {
        .dev_type      = AS61_48E4T_LC,
                .slot_num           = 1,
                .card_name           = "AS61_48E4T_LC",
        .gpio_info     = {
            /* slot 0 */
            {
                .tdi       = 507,
    ...
    {
        .dev_type      = AS61_48E4T_LD,
                .slot_num           = 1,
                .card_name           = "AS61_48E4T_LD",
        .gpio_info     = {
            /* slot 0 */
            {
                .tdi       = 507,
...
int drv_get_my_dev_type(void)
{
    ...
    if (fd < 0) {
        ...
        return B6510_48VS8CQ;	/* Avoid B6510 to obtain different device types */
    }
