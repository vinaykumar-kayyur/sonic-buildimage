...
PCA9548BUSEND      = "PCA9548BUSEND"
DEVICE             = "DEVICE"
GLOBALCONFIG       = "GLOBALCONFIG"
PCA9548START       = "PCA9548START"
DRIVERLISTS        = "DRIVERLISTS"
INIT_PARAM         = "INIT_PARAM"
RAGILE_CARDID      = "RAGILE_CARDID"
RAGILE_PRODUCTNAME = "RAGILE_PRODUCTNAME"
E2_PROTECT         = "E2_PROTECT"
FAN_PROTECT        = "FAN_PROTECT"
MONITOR_CONST      = "MONITOR_CONST"
MAC_LED_RESET      = "MAC_LED_RESET"
...
RAGILE_SERVICE_TAG    = "www.ragile.com.cn"
...
MONITOR_TEMP_MIN           = 38    # Speed regulating start temperature
MONITOR_K                  = 11    # Speed control strategy
MONITOR_MAC_IN             = 35    # Temperature difference between MAC and chip (spare)
MONITOR_DEFAULT_SPEED      = 0x60  # default speed
MONITOR_MAX_SPEED          = 0xFF  # maximum speed (full revolution)
MONITOR_MIN_SPEED          = 0x33  # minimum speed
MONITOR_MAC_ERROR_SPEED    = 0XBB  # MAC abnormal speed
MONITOR_FAN_TOTAL_NUM      = 4     # 3+1 Redundancy design, fault has been reported syslog
MONITOR_MAC_UP_TEMP        = 50    # MAC compare with the temperature inlet  up
MONITOR_MAC_LOWER_TEMP     = -50   # MAC compare with the inlet temperature port  down
MONITOR_MAC_MAX_TEMP       = 100   # 

MONITOR_FALL_TEMP = 4               # Adjustable descent temperature
...
MONITOR_CRITICAL_NUM              = 3 # Restart the number
MONITOR_SHAKE_TIME                = 20 # Stabilization interval
MONITOR_INTERVAL                   = 60

MONITOR_MAC_SOURCE_SYSFS = 0 # 1 is get mac temperature from sysfs, 0 is get mac temperature from bcmcmd
MONITOR_MAC_SOURCE_PATH = None # sysfs file path

###################################################################


#####################MAC regulating parameters(B6510)####################################
MAC_AVS_PARAM ={
    0x72:0x0384 ,
    0x73:0x037e ,
    0x74:0x0378 ,
...
# defaule 6520 template configuration
MAC_DEFAULT_PARAM = {
  "type": 1,                       # type 1 ndicates that the default is not in scope / 0 dicates that the adjustment is not in the range
  "default":0x74,                  # Used with Type
  "loopaddr":0x00,                 # AVS loop address
  "loop":0x00,                     # AVS loop value
  "open":0x00,                     # close write protected value
  "close":0x40,                    # open write protected value
  "bus":2,                         # AVSI2C bus address
  "devno":0x60,                    # AVS address
  "addr":0x21,                     # AVS regulating the address
  "protectaddr":0x10,              # AVS write protected address
  "sdkreg":"DMU_PCU_OTP_CONFIG_8", # SDK register name
  "sdktype": 1,                    # type 0 means no shift is required / 1 means it needs to shift
  "macregloc":24 ,                 # Shift operation
  "mask": 0xff                     # Post-shift mask
}
...
#####################MAC Regulating parameters####################################


####================================Adapter area================================
# RAGILE_COMMON Universal configuration head
# platform   Personality configuration header 

PCA9548START  = 11
PCA9548BUSEND = 74

RAGILE_CARDID      = 0x00004040
RAGILE_PRODUCTNAME = "ragile_b6510"

FAN_PROTECT = {"bus":0, "devno":0x32, "addr":0x19, "open":0x00, "close":0x0f}
rg_eeprom  = "1-0056/eeprom"
E2_LOC = {"bus":1, "devno":0x56}
E2_PROTECT ={"bus":1, "devno":0x33, "addr":0xb0, "open":0, "close":1}
...
DEVICE = [
        ...
        #{"name":"rg_fan","bus":6,"loc":0x53 }, # Fan processing separately
...
#           {"name":"->内存测试 256M","cmd":"memtester 256M 1"},
    ...
    "I2C":[
    # type 1 represents the fetched value compared to value
    # type 2 represents return vaule is True or False
            {"name":"I2C设备检测" ,"cases":[
